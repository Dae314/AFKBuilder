...
const HeroData = readable([
	...
	{ id: 'materia_aw',
		name: 'Materia (Awakened)',
		portrait: './img/portraits/materia_aw.jpg',
		class: 'Mage',
		faction: 'Hypogean',
		type: 'Intelligence',
		tier: 'ascended',
		skills: [
			{ name: 'Crash and Burn',
				type: 'ascension',
				image: './img/skills/materia_aw1.png',
				desc: 'Materia deals damage to all enemies for <em>320%</em> of her Attack Rating. If a hit enemy is being burned by a Cataclysmic Flame or Apocalyptic Flame, any shields they receive over the next <em>7</em> seconds will be destroyed after <em>1</em> second. When an enemy\'s shield is destroyed, they will take damage equal to the shield\'s remaining value. This damage cannot exceed <em>400%</em> of Materia\'s Attack Rating. This effect cannot stack and can only be triggered once every <em>3</em> seconds.<br/><br/>If an enemy being burned by an Apocalyptic Flame is hit by this skill, it will also terrify them for <em>3</em> seconds.',
				unlock: 'Legendary',
				upgrades: [
					...
					{ desc: 'If Immortal Blaze has been unlocked when Materia uses this skill, the enemy who has dealt the most total damage will be hit by a Cataclysmic Flame, and they will deal <em>50%</em> less damage for the next <em>7</em> seconds. This effect cannot stack.',
						unlock: 'Ascended',
						type: 'ascension',
					},
				],
			...
			{ name: 'Immortal Blaze',
				type: 'level',
				image: './img/skills/materia_aw2.png',
				desc: 'Materia deals damage to enemies in front of her for <em>280%</em> of her Attack Rating and hurls a Cataclysmic Flame at the enemy in range with the highest Attack Rating. An enemy being burned by a Cataclysmic Flame loses <em>2%</em> of their max health per second (up to <em>200%</em> of Materia\'s Attack Rating). Cataclysmic Flames cannot be dispelled.<br/><br/>If an enemy being burned by a Cataclysmic Flame is hit by another Cataclysmic Flame, the enemy will lose <em>600</em> Energy and the flame will turn into an Apocalyptic Flame, while the health the enemy loses per second will be increased by <em>50%</em>. The Apocalyptic Flame will revert to a Cataclysmic Flame after <em>4</em> seconds. The effects of Apocalyptic Flames are not stackable, but their duration can be extended.',
				unlock: 21,
				upgrades: [
			...
			{ name: 'From the Ashes',
				type: 'level',
				image: './img/skills/materia_aw3.png',
				desc: 'Every time Materia dies, she transforms into a fireball. While in fireball mode, she is not considered a living hero, and cannot be targeted. She will resurrect after her allies have used their active skills <em>18</em> times or all allied heroes have died. Before she resurrects, the damage dealt by her Cataclysmic Flames is reduced by <em>40%</em>.<br/><br/>When she resurrects, Materia damages nearby enemies for <em>150%</em> of her Attack Rating and terrifies them for <em>2</em> seconds. Materia can resurrect up to <em>2</em> times. This skill cannot be used while you have Talene in your formation.',
				unlock: 41,
				upgrades: [
					{ desc: 'When Materia resurrects, she damages nearby enemies for <em>220%</em> of her Attack Rating. For every enemy Celestial or Dimensional hero on the battlefield, the number of times Materia\'s allies need to use their active skills for her to resurrect is reduced by <em>2</em>.',
						unlock: 3,
						type: 'furn',
					},
					{ desc: 'Materia can now resurrect up to <em>3</em> times. For every enemy Celestial or Dimensional hero on the battlefield, the damage dealt by her Cataclysmic Flames is increased by <em>10%</em>.',
						unlock: 9,
						type: 'furn',
					},
				],
			...
			{ name: 'Smoldering Flame',
				type: 'level',
				image: './img/skills/materia_aw4.png',
				desc: 'Passive. Whenever a hero\'s health falls below <em>15%</em>, they become fuel for the Solaran Furnace and a <em>7</em> second countdown begins. The hero dies when the countdown ends. This effect can only be triggered once for each hero. During the countdown, Materia absorbs <em>50</em> points of the hero\'s Energy per second.<br/><br/>After the affected hero dies, they leave behind a Smoldering Flame that deals damage for <em>50%</em> of Materia\'s Attack Rating to nearby heroes every second.<br/><br/>When this skill is used against a Boss, it will deal one-off damage to the Boss for <em>600%</em> of Materia\'s Attack Rating.',
				unlock: 61,
				upgrades: [
					...
					{ desc: 'When the countdown ends, Materia permanently receives the hero\'s current Attack Rating, Defense Rating, and remaining health (up to <em>100%</em> of her initial Attack Rating for all attribute bonuses). When the hero\'s Smoldering Flame appears, nearby enemies will be burned by Cataclysmic Flames. This effect can also trigger if the hero dies before the countdown ends.',
						unlock: 60,
						type: 'engraving',
					},
				],
			...
			{ name: 'Fallen Flame',
				type: 'level',
				image: './img/skills/materia_aw5.png',
				desc: 'Allied heroes that are not Dimensionals or Celestials will be regarded by Materia as Hypogeans and receive Hypogean factional bonuses as in-combat buffs. These in-combat buffs will be based on the number of Hypogeans in your formation, including heroes regarded as Hypogeans because of this skill.<br/><br/>These in-combat buffs will not affect any factional bonuses in effect at the start of the battle. The affected heroes will also gain a <em>25%</em> damage bonus against Celestials and <em>10</em> Proficiency points in this battle.',
				unlock: 81,
				upgrades: [],
			},
			{ name: 'Endeavor',
		...
		furniture: {
			...
			image: './img/furniture/materia_aw.png',
			upgrades: [
				{ desc: 'When Materia resurrects, she damages nearby enemies for <em>220%</em> of her Attack Rating. For every enemy Celestial or Dimensional hero on the battlefield, the number of times Materia\'s allies need to use their active skills for her to resurrect is reduced by <em>2</em>.',
					unlock: 3,
				},
