		...
		skills: [
			...
			{ name: 'Ironskin',
				...
				upgrades: [
					...
					{ desc: 'When enemies are within striking range of Skreg and dealing damage to him, they will lose <em>8</em> Haste points per <em>3</em> seconds. Ability can be stacked up to <em>3</em> times.',
						unlock: 30,
						type: 'engraving',
					},
				],
