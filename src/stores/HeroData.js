...
const HeroData = readable([
	...
	{ id: 'hendrik',
		...
		furniture: {
			...
			upgrades: [
				{ desc: 'Increases the Defense Rating of an allied hero that is positioned above Hendrik in your formation by <em>25%</em> of Hendrik\'s Defense Rating.',
					unlock: 3,
				},
				{ desc: 'Increases the Defense Rating of an allied hero that is positioned above Hendrik in your formation by <em>60%</em> of Hendrik\'s Defense Rating.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'palmer',
		...
		skills: [
			{ name: 'Illumination',
				type: 'level',
				image: './img/skills/palmer1.png',
				desc: 'Following the will of the Divine Light, Palmer blesses <em>1</em> allied hero who has not been blessed yet, lasting until the end of the battle. Blessed allied heroes have their Crit Damage Amplification increased by <em>15</em> points plus <em>150%</em> of Palmer\'s initial Crit Damage Amplification.<br/><br/>If this skill is used while all allied heroes have already been blessed, Palmer will instead deal damage equal to <em>240%</em> of his Attack Rating to the enemy hero with the highest Attack Rating <em>5</em> times.',
				unlock: 1,
				upgrades: [
					{ desc: 'Increases the Physical Pierce or Magic Pierce of blessed allied heroes by <em>15</em> points plus <em>150%</em> of Palmer\'s initial Magic Pierce, based on the type of damage each allied hero deals.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'When using Illumination, Palmer recovers <em>15%</em> of his max health and heals blessed allied heroes for the same amount.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Sacred Scripture',
				type: 'level',
				image: './img/skills/palmer2.png',
				desc: 'Palmer alternates between reading out Admonitions and Precepts.<br/><br/>Admonitions deal damage to enemies equal to <em>200%</em> of Palmer\'s Attack Rating, and reduces the Attack Rating of the enemy hero with the highest Attack Rating by <em>20%</em> for <em>5</em> seconds.<br/><br/>Precepts target the allied hero with the highest Attack Rating; if their energy is lower than <em>600</em> points, their energy will be restored by <em>80</em> points; otherwise the damage they deal will be increased by <em>15%</em> for <em>8</em> seconds. This buff can stack up to <em>3</em> times.<br/><br/>"Sacred Scripture" serves as Palmer\'s Normal Attack.',
				unlock: 11,
				upgrades: [
					{ desc: 'Increases the damage dealt by Admonitions to <em>220%</em> of Palmer\'s Attack Rating.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'Increases the energy restored by Precepts to <em>120</em> points.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'Increases the damage dealt by Admonitions to <em>240%</em> of Palmer\'s Attack Rating.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Orison',
				type: 'level',
				image: './img/skills/palmer3.png',
				desc: 'At the start of battle, Palmer begins to pray, becoming immune to control effects. Every <em>1.5</em> seconds, the prayer heals nearby allied heroes for <em>80%</em> of Palmer\'s Attack Rating and adds <em>1</em> stack of Faith to Palmer (up to <em>10</em> stacks). Each stack of Faith increases the Attack Rating and Defense Rating of nearby allied heroes by <em>3%</em> and <em>3%</em> of Palmer\'s initial Attack Rating and Defense Rating, respectively.<br/><br/>The prayer ends when Palmer\'s Faith reaches the max number of stacks, the total damage he receives exceeds <em>60%</em> of his max health, or there are no other surviving allied heroes left. After his first prayer ends, the attribute buffs will apply to all allied heroes.',
				unlock: 41,
				upgrades: [
					{ desc: 'The health healed when praying is increased to <em>100%</em> of Palmer\'s Attack Rating.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'When a prayer ends, Palmer will heal nearby allied heroes for <em>30%</em> of their lost health.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'Every <em>1</em> second, the prayer heals nearby allied heroes for <em>100%</em> of Palmer\'s attack rating and adds <em>1</em> stack of Faith (up to <em>15</em> stacks).',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Divine Defense',
				type: 'level',
				image: './img/skills/palmer4.png',
				desc: 'Passive. During battle, if there are at least <em>2</em> surviving allied heroes, the damage received by the allied hero with the lowest health will be reduced by <em>40%</em>. The reduction in damage will be distributed among the other allied heroes. This damage cannot kill them.<br/><br/>Over the next <em>5</em> seconds, <em>60%</em> of the distributed damage will be recovered. The first time an allied hero dies, the other allied heroes will immediately recover all distributed damage, and will receive <em>30%</em> less damage for the next <em>5</em> seconds.',
				unlock: 61,
				upgrades: [
					{ desc: 'The first enemy hero that kills an allied hero will be punished by the Divine Light, reducing their Attack Rating and Energy Recovery rate by <em>30%</em> and <em>30%</em> respectively for <em>5</em> seconds. This effect cannot stack.',
						unlock: 141,
						type: 'level',
					},
					{ desc: '<em>80%</em> of the health lost from distributed damage will be recovered over <em>5</em> seconds.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'The first <em>2</em> enemy heroes that deal damage to allied heroes will be punished by the Divine Light.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			...
			desc: 'Once Palmer\'s Faith is maxed out, he will increase the Crit Rating of all allied heroes by <em>10</em> plus <em>40%</em> of his base Crit Rating.',
			upgrades: [
				{ desc: 'Once Palmer\'s Faith is maxed out, he will heal all allied heroes for <em>100%</em> of his Attack Rating every <em>3</em> seconds.',
					unlock: 10,
				},
				{ desc: 'When Palmer\'s Faith is maxed out, whenever an allied hero deals damage to an enemy hero and their Crit Rating exceeds the enemy\'s Crit Block Rate by at least <em>100</em> points, the damage dealt will be increased by <em>1%</em> for every <em>1</em> excess point (up to 40%).',
					unlock: 20,
				},
				{ desc: 'After ending a prayer, Palmer may pray again in <em>10</em> seconds if his Faith is not maxed out yet.',
					unlock: 30,
				},
			],
		},
		furn_benchmark: 9,
		furniture: {
			name: 'Faultless Faith',
			image: './img/furniture/palmer.png',
			upgrades: [
				{ desc: 'While Palmer is praying, any excess energy he accrues will be saved. The next time he uses his Ultimate, he will recover the saved energy over the next <em>5</em> seconds.',
					unlock: 3,
				},
				{ desc: 'When Palmer prays or uses his Ultimate, the Divine Light will cast Sacred Scripture on his behalf automatically.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'belinda_aw',
		...
		portrait: './img/portraits/belinda_aw.jpg',
		class: 'Mage',
		faction: 'Lightbearer',
		type: 'Intelligence',
		tier: 'ascended',
		skills: [
			{ name: 'Cleansing Flame',
				type: 'ascension',
				image: './img/skills/belinda_aw1.png',
				desc: 'Belinda summons the Divine Flame to cleanse the battlefield, damaging all enemies for <em>230%</em> of her Attack Rating. She is then possessed by the Divine Flame for <em>10</em> seconds, increasing her Attack Rating by <em>5%</em> every second (up to <em>50%</em>).<br/><br/>If Belinda uses this skill while already possessed, it will extend the possession by <em>10</em> seconds and deal extra AoE damage equal to <em>190%</em> of her Attack Rating to all enemy heroes.',
				unlock: 'Legendary',
				upgrades: [
					{ desc: 'If Cleansing Flame damages an enemy multiple times over <em>2</em> seconds, the damage increases by <em>15%</em> each time.',
						unlock: 'Mythic',
						type: 'ascension',
					},
					{ desc: 'If Belinda is possessed, the fewer enemies there are, the more extra damage this skill will deal (up to <em>230%</em> of her Attack Rating).',
						unlock: 'Ascended',
						type: 'ascension',
					},
				],
			...
			{ name: 'Blinding Blaze',
				type: 'level',
				image: './img/skills/belinda_aw2.png',
				desc: 'Belinda scorches an enemy with divine retribution, damaging them for <em>200%</em> of her Attack Rating and burning them for <em>6</em> seconds. When a burned enemy takes damage, they will lose health equal to <em>100%</em> of Belinda\'s Attack Rating over the next <em>1</em> second.<br/><br/>If Belinda is possessed by the Divine Flame, the divine retribution will deal AoE damage to the target and all nearby enemies.',
				unlock: 21,
				upgrades: [
					{ desc: 'When a burned enemy takes damage, they will lose health equal to <em>120%</em> of Belinda\'s Attack Rating over the next <em>1</em> second.',
						unlock: 0,
						type: 'si',
					},
					{ desc: 'When a burned enemy takes damage, they will lose health equal to <em>140%</em> of Belinda\'s Attack Rating over the next <em>1</em> second.',
						unlock: 10,
						type: 'si',
					},
					{ desc: 'When Blinding Blaze damages an enemy, it will also dispel one of their buffs.',
						unlock: 20,
						type: 'si',
					},
					{ desc: 'If Belinda is possessed by the Divine Flame, Blinding Blaze will create <em>1</em> additional flame.',
						unlock: 30,
						type: 'si',
					},
				],
			...
			{ name: 'Sacred Sigil',
				type: 'level',
				image: './img/skills/belinda_aw3.png',
				desc: 'Belinda brands an allied hero with a Sacred Sigil for <em>12</em> seconds. A hero with a Sigil damages nearby enemies for <em>190%</em> of Belinda\'s Attack Rating every <em>3</em> seconds. A portion of the healing the hero receives will be stored by the Sigil, up to <em>30%</em> of Belinda\'s max health. Whenever Belinda takes damage exceeding <em>10%</em> of her max health, she will consume a Sigil to negate the damage and receive the healing stored in the Sigil.<br/><br/>When Belinda is possessed by the Divine Flame, she will automatically receive a Sacred Sigil and will not need to cast this skill to use it.',
				unlock: 41,
				upgrades: [
					{ desc: 'Whenever there is an active Sigil, whenever Belinda deals divine damage, she will recover health equal to <em>50%</em> of the damage.',
						unlock: 3,
						type: 'furn',
					},
					{ desc: 'Each active Sigil increases Belinda\'s Crit Rating by <em>5</em> and Crit Damage Amplification by <em>5</em>.',
						unlock: 9,
						type: 'furn',
					},
				],
			...
			{ name: 'Champion of the Flame',
				type: 'level',
				image: './img/skills/belinda_aw4.png',
				desc: 'Belinda\'s skills deal <em>50%</em> divine damage and <em>50%</em> flame damage. Divine damage cannot Crit, but ignores enemy Defense and Resist. Flame damage always Crits, and each point of Belinda\'s Crit Rating increases the damage dealt by <em>0.4%</em>.<br/><br/>While Belinda is possessed by the Divine Flame, both her divine and flame damage will benefit from the other damage type\'s effects.',
				unlock: 61,
				upgrades: [
					{ desc: 'Flame damage increases Belinda\'s Attack Rating by <em>30%</em>.',
						unlock: 30,
						type: 'engraving',
					},
					{ desc: 'After Belinda has been possessed by the Divine Flame for a total of <em>12</em> seconds, the duration of her possession will be extended by <em>50%</em>.',
						unlock: 60,
						type: 'engraving',
					},
				],
			...
			{ name: 'Blaze of Glory',
				type: 'level',
				image: './img/skills/belinda_aw5.png',
				desc: 'All attribute buffs and Energy recovery Belinda receives from her allies are increased by <em>10%</em>. When an ally helps Belinda recover Energy, she will grant them the Blaze of Glory effect for <em>8</em> seconds.<br/><br/>Whenever an ally with this effect uses an active skill, it will trigger a Cleansing Flame, damaging the target and nearby enemies for <em>190%</em> of Belinda\'s Attack Rating. Every <em>4</em> times Blaze of Glory is used, Belinda will become possessed by the Divine Flame, or have her current possession extended by <em>5</em> seconds, and the divine damage she deals will be permanently increased by <em>2%</em>.',
				unlock: 81,
				upgrades: [],
			},
			{ name: 'Endeavor',
		...
		si_benchmark: 30,
		sig_item: {
			name: 'Strengthen Blinding Blaze',
			image: './img/si/belinda_aw.png',
			desc: 'When a burned enemy takes damage, they will lose health equal to <em>120%</em> of Belinda\'s Attack Rating over the next <em>1</em> second.',
			upgrades: [
				{ desc: 'When a burned enemy takes damage, they will lose health equal to <em>140%</em> of Belinda\'s Attack Rating over the next <em>1</em> second.',
					unlock: 10,
		...
		furn_benchmark: 9,
		furniture: {
			name: 'Strengthen Sacred Sigil',
			image: './img/furniture/belinda_aw.png',
			upgrades: [
				{ desc: 'Whenever there is an active Sigil, whenever Belinda deals divine damage, she will recover health equal to <em>50%</em> of the damage.',
					unlock: 3,
				},
	...
	{ id: 'ginneas',
		name: 'Ginneas',
		portrait: './img/portraits/ginneas.jpg',
		class: 'Tank',
		faction: 'Lightbearer',
		type: 'Strength',
		tier: 'ascended',
		skills: [
			{ name: 'Leaden Smash',
				type: 'level',
				image: './img/skills/ginneas1.png',
				desc: 'Passive: Ginneas\' Burst Hammer can hold up to <em>6</em> shells. At the start of battle, it has <em>3</em> shells. If there are shells remaining when Ginneas deals damage with his skill, <em>1</em> shell will be consumed to increase this damage by <em>60%</em> of his Attack Rating.<br/><br/>Active: Ginneas loads his Burst Hammer with shells, lifts it high, then swings it at the ground, dealing AoE damage <em>3</em> times, each time extending to a wider range. This knocks enemies into the air and stuns them briefly. The damage dealt for each time is <em>230%</em>, <em>280%</em>, and <em>330%</em> of Ginneas\' Attack Rating respectively. Ginneas is immune to control effects while using this skill.',
				unlock: 1,
				upgrades: [
					{ desc: 'At the start of battle, Ginneas has <em>6</em> shells.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'When shells are consumed, the damage dealt by Ginneas ignores enemies\' Dodge.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Hefty Strike',
				type: 'level',
				image: './img/skills/ginneas2.png',
				desc: 'Ginneas smashes enemies within a certain range in front of him with his Burst Hammer, dealing damage equal to <em>250%</em> of his Attack Rating and reducing enemies\' Haste by <em>40</em> points, for <em>5</em> seconds.',
				unlock: 11,
				upgrades: [
					{ desc: 'Increases damage to <em>270%</em> of hero\'s Attack Rating.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'If shells are consumed, Ginneas stuns enemies close to the center of the hammering point for <em>2.5</em> seconds.',
						unlock: 101,
						type: 'level',
					},
			...
			{ name: 'Crushing Mockery',
				type: 'level',
				image: './img/skills/ginneas3.png',
				desc: 'Ginneas charges to the side of the enemy hero who has dealt the highest damage. After dealing damage once for <em>200%</em> of his Attack Rating, he loads shells and taunts nearby enemies for <em>6</em> seconds. While taunting, Ginneas is immune to control effects and receives <em>50%</em> less damage. After the taunt ends, <em>100%</em> of the damage reduced during the taunt is converted into Fearless Shields to be distributed to all allies, with the shields lasting <em>7</em> seconds. The minimum and maximum value of the shield shall be <em>10%</em> and <em>25%</em> of Ginneas\' max health respectively. Ginneas also knocks nearby enemies airborne and deals damage equal to <em>200%</em> of Ginneas\' Attack Rating. If he is using another skill when the taunt ends, he distributes shields after the skill ends and deals damage.',
				unlock: 41,
				upgrades: [
					{ desc: 'Allied heroes protected by Fearless Shields receive <em>25</em> healing points.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'When a Fearless Shield ends, its remaining value is converted into healing for the shield wielder.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'All remaining shells are consumed for the first damage dealt. Each shell consumed increases damage reduction during the taunt further by <em>5%</em>.',
						unlock: 30,
						type: 'engraving',
					},
				],
			},
			{ name: 'Meteor Supernova',
				type: 'level',
				image: './img/skills/ginneas4.png',
				desc: 'Ginneas swings his Burst Hammer, dealing damage to enemies in front of him twice, each time for <em>220%</em> of his Attack Rating. If shells are consumed for the first damage and the enemy\'s remaining shield value is lower than <em>1000%</em> of Ginneas\' Attack Rating, he destroys the enemy\'s shield and grants himself a Fearless Shield with a value equal to <em>50%</em> of the destroyed shield\'s value, up to <em>20%</em> of his max ehalth, for <em>7</em> seconds. If shells are consumed for the second damage, Ginneas knocks the enemy airborne and stuns them for <em>2</em> seconds.',
				unlock: 61,
				upgrades: [
					{ desc: 'Increases damage to <em>250%</em> of Ginneas\' Attack Rating.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'Enemies are stunned for <em>2.5</em> seconds.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'For every <em>6</em> shells consumed, Ginneas grants his ally that has dealt the highest damage a Fearless Shield that can mitigate damage equal to <em>35%</em> of Ginneas\' max health, for <em>7</em> seconds.',
						unlock: 60,
						type: 'engraving',
					},
				],
			...
			{ name: 'Endeavor',
				type: 'engraving',
				image: './img/engraving/lightbearer_endeavor.png',
				desc: 'Within Arena of Heroes, Legends\' Challenger Tournament, Legends\' Championship, Treasure Scramble, and Heroes of Esperia: <em>IS +31.85</em>, <em>HP +13.7%</em>.',
				unlock: 80,
				upgrades: [],
			},
		],
		...
		sig_item: {
			name: 'Overload',
			image: './img/si/ginneas.png',
			desc: 'Each time shells are consumed, the damage dealt this time is increased by <em>80%</em> of Ginneas\' Attack Rating.',
			upgrades: [
				{ desc: 'Each time shells are consumed, the damage dealt this time is increased by <em>100%</em> of Ginneas\' Attack Rating.',
					unlock: 10,
				},
				{ desc: 'Ginneas\' Normal Attack is enhanced, dealing rippling damage for <em>90%</em> of Ginneas\' Attack Rating to the target and enemies behind them.',
					unlock: 20,
				},
				{ desc: 'When Ginneas receives damage that exceeds <em>20%</em> of his max health, he takes <em>90%</em> less damage and loads <em>1</em> shell. This effect can trigger <em>1</em> time every <em>6</em> seconds.',
					unlock: 30,
				},
			],
		},
		furn_benchmark: 9,
		furniture: {
			name: 'Moltenflow Soul',
			image: './img/furniture/ginneas.png',
			upgrades: [
				{ desc: 'For every <em>1</em> shell consumed, Ginneas receives <em>1</em> stack of Will of Steel. Each stack of Will of Steel increases the damage he deals by <em>3%</em> and reduces the damage he takes by <em>3%</em>. This effect can be stacked up to <em>20</em> times.',
					unlock: 3,
				},
				{ desc: 'At the start of battle, Ginneas has <em>5</em> stacks of Will of Steel, while other allies with a Fearless Shield also gain damage buffs and damage reduction corresponding to the current number of stacks of Ginneas\' Will of Steel, up to <em>12</em> stacks.',
					unlock: 9,
				},
			],
		},
		...
		skills: [
			...
			{ name: 'Confrontation',
				...
				upgrades: [
					...
					{ desc: 'Other nearby enemies are terrified for <em>2.5</em> seconds.',
						unlock: 201,
						type: 'level',
					},
	...
	{ id: 'salaki',
		...
		tier: 'ascended',
		skills: [
			{ name: 'Flagellant\'s Flame',
				type: 'level',
				image: './img/skills/salaki1.png',
				desc: 'Salaki sacrifices <em>20%</em> of his current health to increase all allied heroes\' Life Leech by <em>20</em> and Haste by <em>15</em> for <em>7</em> seconds. The lower a target\'s health percentage, the greater the increase to their Life Leech and Haste value, up to <em>1.5</em> times. The increase is the highest when the health percentage is <em>50%</em>.',
				unlock: 1,
				upgrades: [
					{ desc: 'Salaki recovers <em>3%</em> of his lost health every second during the effect of his Ultimate.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'After using his Ultimate, Salaki permanently increases allied heroes\' Attack Rating by <em>4%</em> and Life Leech by <em>4</em> points. This effect can be stacked up to <em>3</em> times.',
						unlock: 161,
						type: 'level',
					},
				],
			},
			{ name: 'Frightening Forcefield',
				type: 'level',
				image: './img/skills/salaki2.png',
				desc: 'Salaki grants a shield to the allied hero with the lowest health percentage lasting <em>5</em> seconds, which negates damage equaling up to <em>20%</em> of Salaki\'s max health, and also terrifies the enemy who attacked said allied hero most recently for <em>2.5</em> seconds.',
				unlock: 11,
				upgrades: [
					{ desc: 'When the shield breaks or its duration ends, it deals AoE damage around the ally equal to <em>140%</em> of Salaki\'s Attack Rating and knocks enemies back.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'Damage is increased to <em>180%</em> of Salaki\'s Attack Rating.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'While Withering Winds is active, the shield\'s value is increased to <em>30%</em> of Salaki\'s max health.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Withering Winds',
				type: 'level',
				image: './img/skills/salaki3.png',
				desc: 'Upon entering battle, Salaki casts a spell that unleashes an acrid haze across the whole battlefield, lasting up to <em>30</em> seconds. While Withering Winds is active, all allied heroes take <em>30%</em> less damage and deal <em>20%</em> less damage. The reduction to damage received will start diminishing <em>5</em> seconds after Withering Winds is cast. The reduction to damage dealt will start diminishing immediately after Withering Winds is cast. These effects will diminish to <em>0%</em> within <em>10</em> seconds.<br/><br/>While using the skill, Salaki is immune to control effects. If he dies, Withering Winds will disappear after <em>5</em> seconds.',
				unlock: 41,
				upgrades: [
					{ desc: 'If Withering Winds has been active for <em>15</em> seconds, permanently increases damage dealt by allied heroes by <em>1%</em> for every second Withering Winds remains active.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'While Withering Winds is active, damage dealt by enemies\' Normal Attacks is reduced by <em>20%</em>',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'If Withering Winds has been active for <em>15</em> seconds, permanently reduces enemies\' Defense Rating by <em>1%</em> for every second that Withering Winds remains active.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Death Deferred',
				type: 'level',
				image: './img/skills/salaki4.png',
				desc: 'Passive: While Salaki is alive, <em>25%</em> of the direct damage received by allies will be spread out every <em>1</em> seconds over the next <em>4</em> seconds.<br/><br/>Active: Salaki manifests a dark flame and attacks the enemy who has dealt the most damage, dealing damage equal to <em>200%</em> of Salaki\'s Attack Rating to the target and all enemies in the flame\'s path.',
				unlock: 61,
				upgrades: [
					{ desc: 'When this skill deals damage, Salaki heals the allied hero with the lowest health percentage, healing <em>50%</em> of the damage caused.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'When this skill deals damage, Salaki reduces the target\'s Attack Rating by <em>12%</em> and Accuracy by <em>50</em> points for <em>4</em> seconds.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'Reduces delayed damage by <em>15%</em>. If an enemy dies, all delayed damage caused by them will be removed.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			name: 'Inheritance',
			image: './img/si/salaki.png',
			desc: 'When Salaki\'s Ultimate ends, all allied heroes receive a shield. The shield\'s value is equal to <em>10%</em> of the total damage caused by allied heroes for the duration of the Ultimate, and lasts for <em>5</em> seconds. The shield\'s value cannot exceed <em>10%</em> of Salaki\'s max health.',
			upgrades: [
				{ desc: 'Shield value increased to <em>15%</em> of the total damage caused by allied heroes for the duration of the Ultimate. Lasts for <em>5</em> seconds, and cannot exceed <em>15%</em> of Salaki\'s max health.',
					unlock: 10,
				},
				{ desc: 'Shield value increased to <em>20%</em> of the total damage caused by allied heroes for the duration of the Ultimate. Lasts for <em>5</em> seconds, and cannot exceed <em>20%</em> of Salaki\'s max health.',
					unlock: 20,
				},
				{ desc: 'If Salaki receives damage that exceeds <em>30%</em> of his current health, the damage will be negated at the cost of one soul vessel. Has a cooldown of <em>4</em> seconds and can only be triggered up to <em>3</em> times.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			name: 'Last Breath',
			image: './img/furniture/salaki.png',
			upgrades: [
				{ desc: 'When Flagellant\'s Flame is used and an allied hero is being controlled, most of the control effects affecting the target will be lifted. This effect can be triggered by each allied hero up to <em>3</em> times per battle.',
					unlock: 3,
				},
				{ desc: 'Using Frightening Forcefield will clear all delayed damage received by the target.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'crassio',
		name: 'Crassio',
		portrait: './img/portraits/crassio.jpg',
		class: 'Ranger',
		faction: 'Mauler',
		type: 'Agility',
		tier: 'ascended',
		skills: [
			{ name: 'Oathsworn Guardian',
				type: 'level',
				image: './img/skills/crassio1.png',
				desc: 'Passive: At the start of battle, Crassio will begin protecting the hero positioned below him.<br/><br/>Active: If the protected hero is alive and there are enemies around them, Crassio damages all enemies near him for <em>320%</em> of his Attack Rating, then teleports to the protected hero and damages all enemies near them for <em>320%</em> of his Attack Rating. Otherwise, Crassio will only slash at the enemies near himself twice, damaging them for <em>320%</em> of his Attack Rating per slash.',
				unlock: 1,
				upgrades: [
					{ desc: 'Crassio receives <em>50%</em> more healing and shields from his protected hero.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'If the skill Dagger Dash has been unlocked, if this skill damages Crassio\'s Quarry they will lose <em>35%</em> Attack Rating and <em>25%</em> Defense Rating for <em>6</em> seconds.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Dagger Dash',
				type: 'level',
				image: './img/skills/crassio2.png',
				desc: 'Crassio targets the enemy hero that has dealt the most damage to his protected hero, marking them as his "Quarry". This skill\'s effects depend on Crassio\'s distance from his Quarry.<br/><br/>If his Quarry is near him, he slashes twice, damaging all enemies near him for <em>250%</em> of his Attack Rating per slash.<br/><br/>If his Quarry is far away, he throws a dagger at them, damaging all enemies near the Quarry for <em>250%</em> of Crassio\'s Attack Rating. He then teleports to catch the dagger, damaging all nearby enemies for <em>250%</em> of his Attack Rating.',
				unlock: 11,
				upgrades: [
					{ desc: 'Increases damage to <em>280%</em> of Crassio\'s Attack Rating.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'When this skill deals damage to Crassio\'s Quarry, it deals extra damage equal to <em>10%</em> of the Quarry\'s max health (up to <em>600%</em> of Crassio\'s Attack Rating).',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'When this skill deals damage to Crassio\'s Quarry, it destroys the Quarry\'s shield if the sheild\'s remaining value is below <em>1000%</em> of Crassio\'s Attack Rating.',
						unlock: 181,
						type: 'level',
					},
				],
			},
			{ name: 'Lethal Deflection',
				type: 'level',
				image: './img/skills/crassio3.png',
				desc: 'Passive: Whenever Crassio or his protected hero take a single round of damage exceeding <em>20%</em> of Crassio\'s max health, he reduces the damage by <em>50%</em> then damages the attacker and all enemies near them for <em>200%</em> of his Attack Rating. This effect can trigger up to <em>3</em> times.<br/><br/>Active: Crassio inflicts damage for <em>200%</em> of his Attack Rating on enemies in front. If there are passive triggers remaining, the enemies will be dealt damage for <em>200%</em> of Crassio\'s Attack Rating equivalent to the remaining passive triggers. After "Lethal Deflection" is cast, the number of passive triggers is refreshed.',
				unlock: 41,
				upgrades: [
					{ desc: 'Increases damage to <em>230%</em> of Crassio\'s Attack Rating.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'The triggering damage is now reduced by <em>60%</em>.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'The skill\'s passive effect can now trigger <em>7</em> times.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Repelling Smash',
				type: 'level',
				image: './img/skills/crassio4.png',
				desc: 'Passive. When the target for protection is attacked at close quarters, Crassio teleports back to the target\'s side, dealing damage for <em>240%</em> of his Attack Rating to surrounding enemies and knocking them back, while granting the target a shield worth <em>280%</em> of his Attack Rating that lasts for <em>6</em> seconds. This skill can trigger up to <em>1</em> time every <em>12</em> seconds. After this skill is used, the cooldown of "Dagger Dash" is refreshed immediately.',
				unlock: 61,
				upgrades: [
					{ desc: 'Enemeis hit by this skill deal <em>30%</em> less damage for <em>5</em> seconds.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'If an attacker breaks the shield granted by this skill, they will be stunned for <em>2</em> seconds.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'At the start of battle, Crassio uses this skill on the area around the enemy hero with the highest Attack Rating. He then grants himself a shield equal in value to the shield he would grant his protected hero. This effect will not trigger this skill\'s cooldown.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			name: 'Vengeance',
			image: './img/si/crassio.png',
			desc: 'Every <em>10</em> times Crassio deals damage to his Quarry, he gains <em>5</em> points of Crit Rating and <em>5</em> points of Tenacity until the end of battle. This effect can stack up to <em>3</em> times.',
			upgrades: [
				{ desc: 'Every <em>10</em> times Crassio deals damage to his Quarry, he gains <em>10</em> points of Crit Rating and <em>10</em> points of Tenacity until the end of battle. This effect can stack up to <em>3</em> times.',
					unlock: 10,
				},
				{ desc: 'If Crassio kills his Quarry, the cooldown of Dagger Dash will reset and he will gain <em>20</em> points of Crit Damage Amplification until the end of battle. This effect can stack up to <em>2</em> times.',
					unlock: 20,
				},
				{ desc: 'Whenever Crassio deals damage to his Quarry with his skills or normal attacks, he deals additional damage to them for <em>160%</em> of his Attack Rating. The damage from this effect cannot trigger this effect. This effect can trigger up to <em>20</em> times per battle.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			...
			image: './img/furniture/crassio.png',
			upgrades: [
				{ desc: 'As long as his protected hero is still alive, Crassio gains <em>50%</em> Attack Rating. Every time the total damage taken by the protected hero reaches <em>10%</em> of their max health, Crassio\'s Attack Rating bonus is reduced by <em>5%</em>. If the protected hero dies, Crassio will lose his Attack Rating bonus.',
					unlock: 3,
				},
				{ desc: 'The first time Crassio\'s protected hero takes fatal damage, he will become invulnerable for <em>3</em> seconds and consume <em>50%</em> of his own health to heal them. He will heal them for <em>40%</em> of their max health plus the health he consumed. If the protected hero dies within the next <em>3</em> seconds, Crassio will recover the health he consumed. He will also gain a <em>50%</em> bonus to Attack Rating and <em>20</em> points of Life Leech for <em>6</em> seconds.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'saurus',
		...
		sig_item: {
			...
			desc: 'When the ability "Relentless" can no longer be stacked any further, Saurus will recover <em>40%</em> worth of his own Attack Rating as health every second.',
			upgrades: [
				{ desc: 'When the ability "Relentless" can no longer be stacked any further, Saurus will recover <em>70%</em> worth of his own Attack Rating as health every second.',
					unlock: 10,
				},
				{ desc: 'When the ability "Relentless" can no longer be stacked any further, Saurus will recover <em>100%</em> worth of his own Attack Rating as health every second.',
					unlock: 20,
				},
				{ desc: 'When the ability "Relentless" can no longer be stacked any further, Saurus\' allies will recover <em>150%</em> worth of his Attack Rating as health every time the abilities "War Strike" or "Burst Strikes" are used without being interrupted.',
					unlock: 30,
				},
			],
		},
		...
		skills: [
			...
			{ name: 'Verdant Shade',
				...
				upgrades: [
					...
					{ desc: 'When a summoned entity of an ally perishes, Nevanthi permanently increases the summoner\'s Attack Rating by <em>8%</em> and Haste by <em>6</em>, which can be stacked up to <em>3</em> times. The value of each increase will not exceed <em>12%</em> of Nevanthi\'s initial Attack Rating.',
						unlock: 60,
						type: 'engraving',
					},
				],
	...
	{ id: 'tamrus',
		name: 'Tamrus',
		portrait: './img/portraits/tamrus.jpg',
		class: 'Warrior',
		faction: 'Wilder',
		type: 'Agility',
		tier: 'ascended',
		skills: [
			{ name: 'Painwheel',
				type: 'level',
				image: './img/skills/tamrus1.png',
				desc: 'Tamrus spins around violently <em>1</em> times. Each spin damages nearby enemeis for <em>220%</em> of his Attack Rating, stuns them, and drags them towards Tamrus. Tamrus spins <em>1</em> more time (up to <em>4</em> times) for every <em>1</em> enemy within range. The range of his spins increases with each spin.<br/><br/>When he stops spinning, he forcefully kicks nearby targets, damaging them for <em>260%</em> of his Attack Rating. Tamrus is immune to control effects while using this skill.',
				unlock: 1,
				upgrades: [
					{ desc: 'Increases the damage of Tamrus\' spins up to <em>240%</em> of his Attack Rating. Increases the damage of his final kick to <em>280%</em> of his Attack Rating.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'Tamrus\' powerful kick also stops enemies within range from attacking or using their skills for <em>1</em> second.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Earth Breaker',
				type: 'level',
				image: './img/skills/tamrus2.png',
				desc: 'Tamrus leaps high into the air then dive-kicks the area with the most enemy heroes, damaging all enemies in the area for <em>200%</em> of his Attack Rating and knocking them airborne. Tamrus is immune to control effects while using this skill.',
				unlock: 11,
				upgrades: [
					{ desc: 'Increases the damage to <em>220%</em> of Tamrus\' Attack Rating.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'Increases the damage to <em>240%</em> of Tamrus\' Attack Rating.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'Tamrus will immediately use Earth Breaker at the start of battle.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Infectious Enthusiasm',
				type: 'level',
				image: './img/skills/tamrus3.png',
				desc: 'The more enemy heroes around Tamrus, the more excited he becomes. For every <em>1</em> enemy heroes near him, Tamrus gains <em>1</em> stack of the Enthusiasm effect (up to <em>5</em> stacks). Each stack of Enthusiasm increases his Dodge by <em>6</em> points and his Magic Suppression by <em>2</em> points.',
				unlock: 41,
				upgrades: [
					{ desc: 'Each stack of Enthusiasm increases Tamrus\' Dodge by <em>9</em> points and his Magic Suppression by <em>3</em> points.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'Shortens the cooldown of Earth Breaker by <em>0.2</em> seconds each time Tamrus successfully dodges or suppresses enemy damage.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'When Tamrus deals damage, the target will lose additional health equal to <em>1%</em> of their lost health for each stack of Enthusiasm he has (up to <em>20%</em> of Tamrus\' Attack Rating). This effect can trigger once every <em>3</em> seconds.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Get Over Here',
				type: 'level',
				image: './img/skills/tamrus4.png',
				desc: 'Tamrus flings his grappling hook at up to <em>2</em> enemies, damaging them for <em>230%</em> of his Attack Rating and dragging them towards himself. Enemies furthest away from Tamrus are targeted first. Hooked enemies have their Attack Rating reduced by <em>10%</em> for <em>5</em> seconds. If there is only <em>1</em> target, the damage is increased to <em>250%</em> of Tamrus\' Attack Rating and the target\'s Attack Rating is reduced by <em>15%</em>.',
				unlock: 61,
				upgrades: [
					{ desc: 'Increases the damage to <em>280%</em> of Tamrus\' Attack Rating. If there is only <em>1</em> target, increases the damage to <em>300%</em> of his Attack Rating.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'Hooked enemies have their Attack Rating reduced by <em>15%</em>. If there is only <em>1</em> target, their Attack Rating is reduced by <em>25%</em>.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'Tamrus also stops enemies who have been hooked and pulled to his vicinity from attacking or using their skills for <em>2.5</em> seconds.',
						unlock: 60,
						type: 'engraving',
					},
				],
			...
			{ name: 'Endeavor',
				type: 'engraving',
				image: './img/engraving/wilder_endeavor.png',
				desc: 'Within Arena of Heroes, Legends\' Challenger Tournament, Legends\' Championship, Treasure Scramble, and Heroes of Esperia: <em>MR +10.14</em>, <em>CBR +10</em>.',
				unlock: 80,
				upgrades: [],
			},
		],
		...
		sig_item: {
			name: 'Jungle Jaunt',
			image: './img/si/tamrus.png',
			desc: 'Enemy heroes hit by "Get Over Here" have their Tenacity permanently reduced by <em>3</em> points. This effect can stack.',
			upgrades: [
				{ desc: 'Enemy heroes hit by "Get Over Here" have their Tenacity permanently reduced by <em>5</em> points. This effect can stack.',
					unlock: 10,
				},
				{ desc: 'Any stacks of Enthusiasm Tamrus receives last until the end of the battle.',
					unlock: 20,
				},
				{ desc: 'Tamrus immediately receives <em>5</em> stacks of Enthusiasm at the start of battle, and his maximum number of Enthusiasm stacks is increased to <em>10</em>.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			name: 'Play With Me',
			image: './img/furniture/tamrus.png',
			upgrades: [
				{ desc: 'Tamrus\' Enthusiasm rubs off on his allies. Each stack of Enthusiasm grants all allied heroes <em>6</em> points of Dodge and <em>2</em> points of Magic Suppression.',
					unlock: 3,
				},
				{ desc: 'Each stack of Enthusiasm Tamrus has increases the Attack Rating of all allied heroes by <em>4%</em>.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'trishea',
		name: 'Trishea',
		portrait: './img/portraits/trishea.jpg',
		class: 'Mage',
		faction: 'Wilder',
		type: 'Intelligence',
		tier: 'ascended',
		skills: [
			{ name: 'Stellar Guide',
				type: 'level',
				image: './img/skills/trishea1.png',
				desc: 'Passive: Trishea observes the universe and changes her Normal Attack according to the guidance of the stars, in the form of either Luminance or Eclipse. After following the guidance, she receives <em>1</em> Feather of Fate.<br/><br/>Luminance: Deals small AoE damage to all enemy heroes for <em>100%</em> of Trishea\'s Attack Rating.<br/><br/>Eclipse: Deals damage to the enemy hero with the highest health for <em>300%</em> of Trishea\'s Attack Rating.<br/><br/>Active: When using the skill, her feathers float and form a Glittering Arc, dealing damage for <em>300%</em> of her Attack Rating to enemies on the path. To use her Ultimate skill, Trishea requires <em>7</em> feathers but does not consume Energy.<br/><br/>Trishea cannot receive Energy when her skill, Starlight Plumes, is still locked.',
				unlock: 1,
				upgrades: [
					{ desc: 'Damage dealt to enemies on the path is increased to <em>350%</em> of Trishea\'s Attack Rating.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'Damage dealt to enemies on the path is increased to <em>400%</em> of Trishea\'s Attack Rating.',
						unlock: 161,
						type: 'level',
					},
				],
			},
			{ name: 'Starlight Plumes',
				type: 'level',
				image: './img/skills/trishea2.png',
				desc: 'Trishea recovers Energy but at an Energy Recovery that is reduced by <em>90%</em>. The Energy she receives each time does not exceed <em>50</em> points. For every <em>200</em> Energy points possessed, she gains <em>2</em> points of Magic Pierce.',
				unlock: 11,
				upgrades: [
					{ desc: 'For every <em>200</em> Energy points possessed, Magic Pierce received by Trishea is increased to <em>4</em> points.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'For every <em>200</em> Energy points possessed, Magic Pierce received by Trishea is increased to <em>6</em> points.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'Reduces Energy Recovery to <em>60%</em>.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Destiny Teller',
				type: 'level',
				image: './img/skills/trishea3.png',
				desc: 'Passive. Trishea\'s outcome from observing the universe and receiving guidance becomes more stable. The more surviving enemy heroes, the more likely the guidance will be Luminance, and when there are <em>5</em> surviving enemy heroes, the chances of receiving Luminance are <em>100%</em>. The fewer surviving enemy heroes, the more likely the guidance will be Eclipse, and when tehre is only <em>1</em> surviving enemy hero, the chances of receiving Eclipse are <em>100%</em>.',
				unlock: 41,
				upgrades: [
					{ desc: 'Damage from Luminance and Eclipse is increased to <em>130%</em> and <em>390%</em> of Trishea\'s Attack Rating respectively.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'Luminance and Eclipse reduce the Defense Rating of damaged enemies by <em>40%</em> for <em>4</em> seconds.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'Damage dealt by enemy heroes hit by Luminance within <em>1.5</em> seconds does not exceed <em>10%</em> of the max health of their target. Each enemy can trigger this effect once every <em>4</em> seconds.<br/><br/>Damage taken by enemy heroes each time they are hit by Eclipse within <em>1.5</em> seconds is at least <em>300%</em> of Trishea\'s Attack Rating. Each enemy can trigger this effect every <em>4</em> seconds.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Astral Mystery',
				type: 'level',
				image: './img/skills/trishea4.png',
				desc: 'Passive. Each feather received by Trishea causes her Ultimate skill, Stellar Guide, to deal additional effects to enemies: each feather received after Eclipse increases damage taken by the target by <em>5%</em> for <em>6</em> seconds; each feather received after Luminance deals additional health loss to the target for <em>30%</em> of Trishea\'s Attack Rating. After she uses her Ultimate skill, Stellar Guide, the additional effect will be reset.',
				unlock: 61,
				upgrades: [
					{ desc: 'Increases damage buffs dealt by each Feather of Fate received after Eclipse to <em>10%</em>.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'Increases health loss dealt by each Feather of Fate after Luminance to <em>50%</em> of Trishea\'s Attack Rating.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'When using her Ultimate skill at full energy, Trishea will immediately use the Ultimate skill once more. The additional effects granted to the Ultimate skill from the skill, Astral Mystery, will be reset after the Ultimate skill is used again.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			...
			image: './img/si/trishea.png',
			desc: 'While observing the universe, Trishea is immune to control effects.',
			upgrades: [
				{ desc: 'While observing the universe, Trishea receives <em>35%</em> Damage Reduction.',
					unlock: 10,
				},
				{ desc: 'Each Feather of Fate received by Trishea permanently increases her initial Attack Rating by <em>2%</em>.',
					unlock: 20,
				},
				{ desc: 'Each Feather of Fate received by Trishea permanently increases her initial Attack Rating by <em>4%</em>.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			name: 'Oracle\'s Notes',
			image: './img/furniture/trishea.png',
			upgrades: [
				{ desc: 'For every <em>50</em> Energy points received, Trishea immediately receives <em>1</em> Feather of Fate, up to <em>20</em> Feathers of Fate. Such Feather of Fate will render the additional effects granted to Trishea\'s Ultimate skill the same as those granted by the Feathers of Fate the last time she received guidance.',
					unlock: 3,
				},
				{ desc: 'When Trishea\'s Energy is full, she receives <em>1</em> Feather of Fate every <em>3</em> seconds. Such Feather of Fate will render the additional effects granted to Trishea\'s Ultimate skill the same as those granted by the Feathers of Fate the last time she received guidance.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'kelthur',
		...
		furniture: {
			...
			upgrades: [
				{ desc: 'Kelthur is able to proactively trigger the ability "Spectral Riposte" while the ability "Ethereal Resurgence" is in effect. Cooldown time of "Spectral Riposte" is equal to the ability\'s regular passive interval time.',
					unlock: 3,
				},
				{ desc: '"Spectral Riposte" cooldown time is reduced by <em>2</em> seconds.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'edwin',
		name: 'Edwin',
		portrait: './img/portraits/edwin.jpg',
		class: 'Tank',
		faction: 'Graveborn',
		type: 'Strength',
		tier: 'ascended',
		skills: [
			{ name: 'Liege Lord',
				type: 'level',
				image: './img/skills/edwin1.png',
				desc: 'Passive: At the start of battle, Edwin creates a Dominion that follows him around the battlefield. Allied heroes within a Dominion take <em>70%</em> less normal attack damage.<br/><br/>Active: Edwin damages enemies in front of him for <em>250%</em> of his Attack Rating <em>4</em> times. He then creates a large temporary Dominion in the area with the most allied heroes for <em>12</em> seconds and damages enemeis within the new Dominion for <em>300%</em> of his Attack Rating. This temporary Dominion has the same effect as the regular Dominion, but their effects do not stack with one another.<br/><br/>Edwin is immune to control effects while casting this skill. If this skill is used again while there is already a temporary Dominion on the battlefield, it will be replaced by a new temporary Dominion.',
				unlock: 1,
				upgrades: [
					{ desc: 'Allied heroes within a Dominion take <em>80%</em> less normal attack damage.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'Allied heroes within a Dominion deal <em>35%</em> extra damage.',
						unlock: 161,
						type: 'level',
					},
				],
			},
			{ name: 'Disarming Flurry',
				type: 'level',
				image: './img/skills/edwin2.png',
				desc: 'Edwin slashes enemies in front of him <em>3</em> times. The first two slashes each deal damage for <em>230%</em> of his Attack Rating. The final slash deals damage for <em>260%</em> of his Attack Rating.<br/><br/>If an enemy is within on if Edwin\'s Domains, the final slash will also silence them for <em>2</em> seconds and reduce their Defense Rating by <em>30%</em> for <em>5</em> seconds.<br/><br/>If this skill is interrupted by Rebel\'s Reprisal before the final slash, the latter skill will also silence and reduce the Defense Rating of enemies within a Dominion in the same manner as the final slash.',
				unlock: 11,
				upgrades: [
					{ desc: 'The duration of the final slash\'s Defense Rating reduction is extended to <em>6</em> seconds.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'Each of the first two slashes now deal damage for <em>260%</em> of Edwin\'s Attack Rating, while the final slash now deals damage for <em>290%</em> of his Attack Rating.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'The duration of the final slash\'s Silence effect is extended to <em>3</em> seconds.',
						unlock: 181,
						type: 'level',
					},
				],
			},
			{ name: 'Rebel\'s Reprisal',
				type: 'level',
				image: './img/skills/edwin3.png',
				desc: 'Every <em>5</em> times his Dominions reduce normal attack damage, Edwin will counterattack nearby enemies, damaging them for <em>230%</em> of his Attack Rating. These counterattacks will interrupt Edwin\'s normal attacks and his Disarming Flurry skill, but if a counterattack is triggered while he is using his Ultimate, it will be launched after the Ultimate ends.<br/><br/>If there are no enemies around Edwin when he triggers a counterattack, it will be stored until there are enemies around him. He can store up to <em>3</em> counterattacks.',
				unlock: 41,
				upgrades: [
					{ desc: 'Every <em>4</em> times his Dominions reduce normal attack damage, Edwin will counterattack nearby enemies.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'Increases counterattack damage to <em>250%</em> of Edwin\'s Attack Rating.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'Whenever Edwin takes skill damage, he will negate the damage, become invulnerable for <em>3</em> seconds, and trigger a counterattack. This effect can be triggered up to <em>1</em> time every <em>8</em> seconds.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Royal Favor',
				type: 'level',
				image: './img/skills/edwin4.png',
				desc: 'Whenever an allied hero within a Dominion takes a single round of damage that exceeds <em>10%</em> of their max health, the attacker is silenced for <em>2.5</em> seconds. This effect can only be triggered up to <em>1</em> time every <em>10</em> seconds against each attacker.',
				unlock: 61,
				upgrades: [
					{ desc: 'The duration of the silencing effect is extended to <em>3.5</em> seconds. This effect can now be triggered up to <em>1</em> time every <em>8</em> seconds against each attacker.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'Whenever an allied hero within a Dominion takes normal attack damage, they recover <em>15</em> Energy. Each allied hero can recover up to <em>150</em> Energy from this effect per battle.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'Whenever an allied hero within a Dominion takes normal attack damage, they recover <em>30</em> Energy. Each allied hero can recover up to <em>300</em> Energy from this effect per battle, while Edwin can recover up to <em>2000</em> Energy from this effect.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		si_benchmark: 30,
		sig_item: {
			name: 'Traitor\'s Vengeance',
			image: './img/si/edwin.png',
			desc: '<em>30%</em> of the normal attack damage reduced by Edwin\'s Dominions will be stored and used to increase the damage of his next Rebel\'s Reprisal counterattack (up to <em>120%</em> of Edwin\'s Attack Rating).',
			upgrades: [
				{ desc: '<em>60%</em> of the normal attack damage reduced by Edwin\'s Dominions will be stored and used to increase the damage of his next Rebel\'s Reprisal counterattack (up to <em>240%</em> of Edwin\'s Attack Rating).',
					unlock: 10,
				},
				{ desc: 'The damage of Edwin\'s Ultimate increases by <em>20%</em> (up to <em>100%</em>) each time a Rebel\'s Reprisal counterattack is triggered.',
					unlock: 20,
				},
				{ desc: 'Rebel\'s Reprisal counterattacks deal extra damage equal to <em>10%</em> of the enemy\'s max health (up to <em>800%</em> of Edwin\'s Attack Rating).',
					unlock: 30,
				},
			],
		},
		furn_benchmark: 9,
		furniture: {
			name: 'Sphere of Dominance',
			image: './img/furniture/edwin.png',
			upgrades: [
				{ desc: 'The radius of Edwin\'s Dominions is increased to <em>115%</em> of their original radius.',
					unlock: 3,
				},
				{ desc: 'When an allied hero within a Dominion takes normal attack damage, the attacker loses <em>100</em> Energy. This effect can only be triggered up to <em>1</em> time every <em>1.5</em> seconds against each attacker.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'veithael',
		name: 'Veithael',
		portrait: './img/portraits/veithael.jpg',
		class: 'Tank',
		faction: 'Celestial',
		type: 'Agility',
		tier: 'ascended',
		skills: [
			{ name: 'Warmonger',
				type: 'level',
				image: './img/skills/veithael1.png',
				desc: 'Passive: Veithael gains <em>50</em> Energy per second if he is not being controlled, but loses <em>150</em> Energy per second if he is being controlled.<br/><br/>Active: Veithael spends <em>300</em> Energy to swing his sword, damaging nearby enemies for <em>340%</em> of his Attack Rating. After using this skill, every subsequent time Veithael uses a skill, he will spend <em>350</em> Energy to trigger an Energy Burst, damaging all enemies in front of him for <em>10%</em> of his max health. Energy burst damage cannot exceed <em>500%</em> of his Attack Rating. When Veithael\'s Energy falls below <em>350</em>, he will stop triggering Energy Bursts until he uses this skill again. Veithael will not use this skill while an Energy Burst can still be triggered.',
				unlock: 1,
				upgrades: [
					{ desc: 'Reduces the Energy cost of triggering an Energy Burst to <em>250</em> points.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'Each time Veithael deals damage with an Energy Burst, the damage he receives is permanently reduced by <em>5%</em>. This effect can be stacked up to a maximum reduction of <em>40%</em>.',
						unlock: 161,
						type: 'level',
					},
				],
			},
			{ name: 'Brutal Backswing',
				type: 'level',
				image: './img/skills/veithael2.png',
				desc: 'Passive: Veithael\'s max health is increased by <em>30%</em> at the start of the battle. His health percentage remains unchanged. When Veithael takes damage, it will reduce his max health until it reaches its original value.<br/><br/>Active: Veithael charges forward, damaging enemies for <em>240%</em> of his Attack Rating and knocking them back. He then returns and swings his sword, which damages enemies for <em>320%</em> of his Attack Rating, stuns them for <em>1</em> second, and heals Veithael for <em>25%</em> of his max health. For the duration of this skill, Veithael receives <em>40%</em> less damage. If this skill triggers an Energy Burst, enemies will be stunned for <em>5</em> seconds.',
				unlock: 11,
				upgrades: [
					{ desc: 'Increases charge damage to <em>280%</em> of Veithael\'s Attack Rating.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'Reduces damage Veithael receives by <em>50%</em> for the skill\'s duration.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'Veithael is immune to control effects for the skill\'s duration.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Hear No Evil',
				type: 'level',
				image: './img/skills/veithael3.png',
				desc: 'If Veithael is about to be inflicted with a control effect, he negates the effect and swings his sword, damaging nearby enemies for <em>260%</em> of his Attack Rating and interrupting their casting. For each enemy hit, Veithael is healed for <em>100%</em> of his Attack Rating. This skill can only be triggered once every <em>15</em> seconds. If this skill triggers an Energy Burst, enemies hit by the Energy Burst permanently lose <em>3</em> points of Insight and <em>3</em> points of Proficiency.',
				unlock: 41,
				upgrades: [
					{ desc: 'Damage is increased to <em>320%</em>.',
						unlock: 121,
					...
					{ desc: 'For each enemy hit, Veithael is healed for <em>120%</em> of his Attack Rating.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'The cooldown of this skill is reduced to <em>12</em> seconds. If this skill triggers an Energy Burst, enemies hit by the Energy Burst permanently lose <em>6</em> Insight points and <em>6</em> Proficiency points.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Head Held High',
				...
				upgrades: [
					...
					{ desc: 'Attack Rating buff is increased to <em>1.5%</em>.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			name: 'Godly Physique',
			image: './img/si/veithael.png',
			desc: 'The max health bonus Veithael receives at the start of battle is increased to <em>50%</em>. His health percentage remains unchanged.',
			upgrades: [
				{ desc: 'Every <em>1%</em> bonus to Veithael\'s max health increases his Attack Rating by <em>1%</em> to a maximum of <em>50%</em>.',
					unlock: 10,
				},
				{ desc: 'Every <em>1%</em> bonus to Veithael\'s max health increases his Dodge by <em>3</em> points to a maximum of <em>150</em> points.',
					unlock: 20,
				},
				{ desc: 'All allied heroes gain <em>100%</em> of the attribute bonuses from Godly Physique.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			...
			image: './img/furniture/veithael.png',
			upgrades: [
				{ desc: 'When an Energy Burst is triggered, every <em>1%</em> bonus to Veithael\'s max health increases the max damage of the Energy Burst by <em>2%</em> of his Attack Rating.',
					unlock: 3,
				},
				{ desc: 'When Veithael receives excess healing, it increases his max health, up to <em>100%</em> of his original max health. His health percentage remains unchanged.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'athalia_aw',
		name: 'Athalia (Awakened)',
		portrait: './img/portraits/athalia_aw.jpg',
		class: 'Warrior',
		faction: 'Celestial',
		type: 'Agility',
		tier: 'ascended',
		skills: [
			{ name: 'Divine Descent',
				type: 'ascension',
				image: './img/skills/athalia_aw1.png',
				desc: 'Athalia descends from the heavens and creates a Judgement Sphere that lasts for <em>5</em> seconds targeting the enemy hero with the highest Attack Rating, dealing damage for <em>350%</em> of her Attack Rating to the target while knocking back all other enemies within range to the edge of the sphere. Then, she uses all her Sacret Blades to attack the target, with each blade dealing damage for <em>200%</em> of her Attack Rating to the target. When a Judgement Sphere is active, the target cannot move and Athalia prioritizes attacking them, while the Judgement Sphere continues to knock back enemies other than the target.<br/><br/>A battlefield can only have <em>1</em> Judgement Sphere, which disappears when the target dies.',
				unlock: 'Legendary',
				upgrades: [
					{ desc: 'The cooldown time of the skill "Ripping Slash" is reset immediately after her Ultimate is used.',
						unlock: 'Mythic',
						type: 'ascension',
					},
					{ desc: 'When a Judgement Sphere is created, most of the target\'s buffs will be dispelled. While a Judgement Sphere exists, the skill "Ripping Slash" will only attack the target with multiple slashes.',
						unlock: 'Ascended',
						type: 'ascension',
					},
				],
			...
			{ name: 'Ripping Slash',
				type: 'level',
				image: './img/skills/athalia_aw2.png',
				desc: 'Athalia traverses the battlefield at high speed, slashing <em>3</em> enemy heroes with the highest Attack Rating for <em>3</em> times, dealing damage for <em>220%</em> of her Attack Rating to the target and enemies in her path. When the skill ends, Athalia teleports to the enemy hero with the highest Attack Rating. During the skill, Athalia is invincible and untargetable.',
				unlock: 21,
				upgrades: [
					{ desc: 'When an enemy suffers multiple slashes, each round of damage they receive from the skill this time is increased by <em>30%</em>.',
						unlock: 0,
						type: 'si',
					},
					{ desc: 'A slash from this skill deals additional damage equal to <em>10%</em> of the health already lost by the target, up to <em>400%</em> of Athalia\'s Attack Rating.',
						unlock: 10,
						type: 'si',
					},
					{ desc: 'The number of slashes this skill can inflict is increased by <em>1</em> time.',
						unlock: 20,
						type: 'si',
					},
					{ desc: 'After Athalia kills an enemy hero, the cooldown time of this skill is reduced by <em>50%</em> and she immediately gains <em>2</em> Sacred Blades.',
						unlock: 30,
						type: 'si',
					},
				],
			...
			{ name: 'Dancing Blades',
				type: 'level',
				image: './img/skills/athalia_aw3.png',
				desc: 'Passive: All damage and health loss suffered by Athalia from behind is reduced by <em>45%</em>.<br/><br/>Active: Athalia deals damage for <em>180%</em> of her Attack Rating to enemies within a certain range <em>3</em> times, while the skill\'s passive effects mitigate damage and health loss from all directions for <em>5</em> seconds. During the skill, Athalia is immune to control effects.',
				unlock: 41,
				upgrades: [
					{ desc: 'This skill dispels most of Athalia\'s debuffs. After the skill ends, Athalia will deal additional magic damage equal to <em>125%</em> of her Attack Rating for the subsequent <em>5</em> times she deals damage.',
						unlock: 3,
						type: 'furn',
					},
					{ desc: 'The lower Athalia\'s health percentage, the higher the Damage Reduction from the skill\'s passive effects, which can go up to <em>65%</em>.',
						unlock: 9,
						type: 'furn',
					},
				],
			...
			{ name: 'Sword Crafter',
				type: 'level',
				image: './img/skills/athalia_aw4.png',
				desc: 'Passive. For every <em>6</em> times Athalia has dealt damage, she receives <em>1</em> Sacred Blade. This effect can only trigger up to <em>4</em> times every <em>8</em> seconds, and Athalia can hold up to <em>6</em> Sacred Blades.<br/><br/>Damage dealt by Athalia is increased based on her and her target\'s current health percentage. The greater the difference between her and her target\'s current health percentage, the more the damage increase, by up to <em>40%</em>.',
				unlock: 61,
				upgrades: [
					{ desc: 'When an allied hero uses their Ultimate skill, Athalia receives <em>1</em> Sacred Blade. This effect can only be triggered once every <em>5</em> seconds by each allied hero. When an allied hero dies, Athalia receives <em>2</em> Sacred Blades.',
						unlock: 30,
						type: 'engraving',
					},
					{ desc: 'When Athalia gains a Sacred Blade, she deals damage for <em>180%</em> of her Attack Rating to the enemy with the highest Energy, ignoring the target\'s Defense and reducing their current Energy by <em>20%</em> or at least <em>100</em> Energy points.',
						unlock: 60,
						type: 'engraving',
					},
				],
			...
			{ name: 'Piercing Aura',
				type: 'level',
				image: './img/skills/athalia_aw5.png',
				desc: 'Every <em>5</em> Sacred Blades Athalia receives permanently increase damage dealt by and Physical Pierce of her allied heroes by <em>10%</em> and <em>6</em> points respectively. This effect can be stacked up to <em>3</em> times. When an allied hero receives a control effect, the attack takes damage equal to <em>200%</em> of Athalia\'s Attack Rating and is unable to recover Energy in the next <em>4</em> seconds. This effect can only be triggered once every <em>10</em> seconds by each allied hero.',
				unlock: 81,
				upgrades: [],
			},
			{ name: 'Endeavor',
		...
		si_benchmark: 30,
		sig_item: {
			name: 'Strengthen Ripping Slash',
			image: './img/si/athalia_aw.png',
			desc: 'When an enemy suffers multiple slashes, each round of damage they receive from the skill this time is increased by <em>30%</em>.',
			upgrades: [
				{ desc: 'A slash from this skill deals additional damage equal to <em>10%</em> of the health already lost by the target, up to <em>400%</em> of Athalia\'s Attack Rating.',
					unlock: 10,
		...
		furn_benchmark: 9,
		furniture: {
			name: 'Strengthen Dancing Blades',
			image: './img/furniture/athalia_aw.png',
			upgrades: [
				{ desc: 'This skill dispels most of Athalia\'s debuffs. After the skill ends, Athalia will deal additional magic damage equal to <em>125%</em> of her Attack Rating for the subsequent <em>5</em> times she deals damage.',
					unlock: 3,
				},
	...
	{ id: 'daemia',
		name: 'Daemia',
		portrait: './img/portraits/daemia.jpg',
		class: 'Mage',
		faction: 'Celestial',
		type: 'Intelligence',
		tier: 'ascended',
		skills: [
			{ name: 'Floral Shade',
				type: 'level',
				image: './img/skills/daemia1.png',
				desc: 'Daemia creates Lush Shade for <em>10</em> seconds and dispels most of the negative effects suffered by all allies and enemies. During this time, they are unable to recover health, damage dealt is increased by <em>100%</em>, and health cannot become less than <em>20%</em> from direct damage. These effects do not work on Bosses.<br/><br/>After Lush Shade ends, Daemia removes her control effects and swings her staff to deal damage for <em>300%</em> of her Attack Rating to all enemies. After Lush shade has ended for <em>5</em> seconds, Daemia can use her Ultimate once again.',
				unlock: 1,
				upgrades: [
					{ desc: 'When Lush Shade ends, Daemia restores the health of all allies possessing Dewy Nectar for <em>280%</em> of her Attack Rating.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'Any excess Energy of Daemia\'s will increase her Crit Damge Amplification, with every <em>1</em> Energy point boosting Crit Damage Amplifiction by <em>0.1</em> points, up to <em>50</em> points. This carries on until the next time Demi uses her Ultimate.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Days of Bloom',
				type: 'level',
				image: './img/skills/daemia2.png',
				desc: 'Passive: Every <em>8</em> seconds, Demia grants Dewy Nectra to allied heroes within her half of the battlefield for <em>10</em> seconds. This effect cannot be stacked.<br/><br/>Active: Daemia unleashes a flurry of petaals, dealing damage for <em>200%</em> of Daaemia\'s Attack Rating to all enemies. If used actively when Lush Shade is active, this skill additionally restores <em>200</em> Energy points for heroes possessing Dewy Nectar.',
				unlock: 11,
				upgrades: [
					{ desc: 'When Torrid Wind is active, this skill, when used ctively, will summon gust of strong wind, dealing damage for <em>200%</em> of Daemia\'s Attack Rating to all enemies <em>3</em> times.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'When Blazing Sun is active, this skill, when used actively, will cast spells continuously to intensify the sunlight, damaging the health of all enemies for <em>100%</em> of Daemia\'s Attack Rating every <em>1</em> second. The health lost increases with time, up to <em>200%</em> and until the end of the current Blazing Sun.<br/><br/>When Torrid Wind and Blazing Sun are both active, a gust of strong wind will be summoned for every <em>3</em> seconds the spells are being cast, dealing damage for <em>200%</em> of Daemia\'s Attack Rating to all enemies <em>3</em> times.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'At the start of battle, Daemia grants Dewy Nectar to all allies within her side of the battlefield.',
						unlock: 181,
						type: 'level',
					},
				],
			},
			{ name: 'Scorching Monsoon',
				type: 'level',
				image: './img/skills/daemia3.png',
				desc: 'Creates Torrid Wind that lasts for <em>10</em> seconds. While Torrid Wind is active, each time an enemy takes damage increases the damage it suffers subsequently by <em>3%</em>. This effect can be stacked up to <em>8</em> times until Torrid Wind ends, and cannot be dispelled. This skill will not be used agin if Torrid Wind is present on the battlefield.',
				unlock: 41,
				upgrades: [
					{ desc: 'The received damage is increased to <em>5%</em>.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'While Torrid Wind is active, an enemy loses <em>100</em> Energy points for every cumulative <em>10</em> times they have taken damage.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'When an ally possessing Dewy Nectar deals damage while Torrid Wind is ctive, Daemia summons a Wind Blade, dealing additional damage for <em>150%</em> of her Attack Rating to the target who has been damaged by the ally possessing the Dewy Nectar.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Sweltering Heat',
				type: 'level',
				image: './img/skills/daemia4.png',
				desc: 'Daemia creates Blazing Sun that lasts for <em>10</em> seconds. While Blazing Sun is active, each time an enemy deals damage reduces their damage output by <em>3%</em>. This effect can be stacked up to <em>8</em> times, and lasts until Blazing Sun ends. This effect cannot be dispelled. This skill will not be used again if Blazing Sun is present on the battlefield.',
				unlock: 61,
				upgrades: [
					{ desc: 'The damage enemies deal is reduced by <em>5%</em> each time they attack.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'For every cumulative <em>10</em> times an enemy has dealt damage during Blazing Sun, they become stunned for <em>5</em> seconds.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'While Blazing Sun is active, the Tenacity of allies possessing Dewy Nectar is increased by <em>30</em> points.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			name: 'Sultry Season',
			image: './img/si/daemia.png',
			desc: 'Once allied have received Dewy Nectar a cumulative <em>2</em> times, their Attack Rating is permanently increased by <em>15%</em> points.',
			upgrades: [
				{ desc: 'Once allied have received Dewy Nectar a cumulative <em>4</em> times, their Attack Rating is permanently increased by <em>30%</em> points.',
					unlock: 10,
				},
				{ desc: 'Once allied have received Dewy Nectar a cumulative <em>6</em> times, their Attack Rating is permanently increased by <em>50%</em> points.',
					unlock: 20,
				},
				{ desc: 'Damage dealt by enemies within Daemia\'s half of the battlefield to allies possessing Dewy Nectar is reduced by <em>50%</em>.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			name: 'Endless Summer',
			image: './img/furniture/daemia.png',
			upgrades: [
				{ desc: 'Increases the initial duration of Torrid Wind and Blazing Sun to <em>15</em> seconds.',
					unlock: 3,
				},
				{ desc: 'Torrid Wind is created at the start of battle.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'canisa_ruke',
		...
		skills: [
			{ name: 'Lightning Lock',
				...
				desc: 'Passive: Canisa & Ruke launch their Normal Attacks separately.<br/><br/>Active: Canisa & Ruke jump to the area with the most enemies and both deal damage to nearby enemies equal to <em>250%</em> and <em>310%</em> of their Attack Rating, respectively. Enemies hit by both attacks will be chained for <em>12</em> seconds.<br/><br/>Canisa & Ruke will evenly distribute <em>30%</em> of the direct damage they take among the chained enemies. This distributed damage cannot exceed <em>430%</em> of Canisa & Ruke\'s Attack Rating.',
				unlock: 1,
				upgrades: [
					...
					{ desc: 'The percentage of damage distributed to chained enemies is increased to <em>35%</em>. This damage will not exceed <em>460%</em> of Canisa & Ruke\'s Attack Rating.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Howl of Fury',
				...
				desc: 'Canisa & Ruke let out a howl that knocks back surrounding enemies for <em>280%</em> of their Attack Rating, knocking them back and stunning them for <em>2</em> seconds. In addition, Canisa & Ruke gain a shield that lasts for <em>8</em> seconds, worth <em>25%</em> of their max health.',
				unlock: 11,
				upgrades: [
			...
			{ name: 'Wound Reversal',
				...
				desc: 'Passive. At the start of  battle, Canisa & Ruke\'s Max Health drops by <em>30%</em>. The first time they receive fatal damage, they will be immune to all damage and control effects for <em>2.5</em> seconds, fully heal themselves, and receive a <em>30%</em> buff to max health.<br/><br/>They will also gain <em>10</em> points of  Physical Resist or <em>20</em> points of Magic Resist until the end of battle, depending on whether they\'ve taken more physical or magic damage.',
				unlock: 41,
				upgrades: [
					{ desc: 'Increases Physical Resist buff to <em>15</em> points and Magic Resist buff to <em>30</em> points.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'Canisa & Ruke are now immune to damage and control effects for <em>3.5</em> seconds.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'Before taking fatal damage for the first time, Canisa & Ruke\'s Attack and Defense Ratings increase by <em>2.5%</em> per second, up to <em>45%</em>. These buffs last until the end of battle.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Cage of Fire',
				...
				desc: 'Canisa & Ruke forge a flaming cage around themselves that lasts up to <em>7</em> seconds. Every <em>1</em> second, the cage damages enemies within it for <em>140%</em> of Canisa & Ruke\'s Attack Rating, and reduces the enemies\' Defense Ratings by <em>6%</em> (up to <em>18%</em>), for <em>3</em> seconds. Enemies moving to the edge of the cage are periodically knocked back to the center and stunned for <em>1.5</em> seconds.',
				unlock: 61,
				upgrades: [
					{ desc: 'Damage is increased to <em>160%</em> of Canisa & Ruke\'s Attack Rating.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'When Canisa & Ruke forge a cage, it will drag nearby enemies into it.',
						unlock: 221,
						type: 'level',
					},
		...
		sig_item: {
			...
			desc: 'Reduces the damage Canisa & Ruke take from enemies that are chained or within a Cage of Fire by <em>15%</em>. This does not affect the amount of damage distributed to chained enemies.',
			upgrades: [
				{ desc: 'When Canisa & Ruke distribute direct damage to chained enemies, each enemy will take at least <em>40%</em> of the damage.',
					unlock: 10,
				},
				{ desc: 'Reduces the damage Canisa & Ruke take from enemies that are chained or within a Cage of Fire by <em>30%</em>. This does not affect the amount of damage distributed to chained enemies.',
					unlock: 20,
				},
				{ desc: '"Howl of Fury" and "Cage of Fire" also chain enemies, but either skill can only chain up to <em>1</em> enemies at once.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			...
			upgrades: [
				{ desc: 'Ruke\'s attacks heal Canisa & Ruke for <em>35%</em> of the damage they deal, up to <em>300%</em> of their Attack Rating.',
					unlock: 3,
				},
				{ desc: 'Canisa\'s attacks reduce the target\'s energy by <em>160</em> points.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'olgath',
		name: 'Olgath',
		portrait: './img/portraits/olgath.jpg',
		class: 'Ranger',
		faction: 'Hypogean',
		type: 'Agility',
		tier: 'ascended',
		skills: [
			{ name: 'Infernal Bombardment',
				type: 'level',
				image: './img/skills/olgath1.png',
				desc: 'Olgath leaps into the air with Dealth Knell and fires an infernal shot at each enemy in turn, until all enemies have taken damage from this skill <em>1</em> time or there are no more targetable enemies. Olgath will fire at least <em>5</em> and at most <em>10</em> infernal shots each time this skill is used. He is invincible when firing.<br/><br/>Infernal shots consume <em>1</em> loaded shell of each type, which will be fused together and fired at the target, dealing AoE damage equal to <em>250%</em> of Olgath\'s Attack Rating and triggering the effects of the consumed shells. If no shells are consumed, only the AoE damage will be dealt.',
				unlock: 1,
				upgrades: [
					{ desc: 'Olgath\'s bombardment continues until all enemies have taken damage from this skill <em>1</em> time, or there are no more targetable enemies. He will fire at least <em>5</em> and at most <em>15</em> infernal shots each time this skill is used.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'Olgath\'s bombardment continues until all enemies have taken damage from this skill <em>2</em> times, or there are no more targetable enemies. He will fire at least <em>10</em> and at most <em>30</em> infernal shots each time this skill is used.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Slotted Shell',
				type: 'level',
				image: './img/skills/olgath2.png',
				desc: 'Olgath creates a ball of Scatter Shells, Shrapnel Shells, and Piercing Shells in that order. He feeds the ball to Death Knell, loading it with <em>3</em> shells of that type, then fires <em>1</em> infernal shots. Death Knell can store up to <em>3</em> shells of each type.<br/><br/>When firing an infernal shot, consuming a Scatter Shell greatly increases the AoE of the shot.<br/><br/>Consuming a Shrapnel Shell fires <em>2</em> extra shots, dealing AoE damage equal to <em>250%</em> of Olgath\'s Attack Rating.<br/><br/>Consuming a Piercing Shell causes the target to lose additional health equal to <em>80%</em> of Olgath\'s Attack Rating.',
				unlock: 11,
				upgrades: [
					{ desc: 'When firing an infernal shot, each type of shell consumed will increase the damage of the shot by <em>20%</em>.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'When firing an infernal shot, if the shot does not consume any Scatter Shells, each of the other types of shells will increase the shot\'s AoE.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'Each time Slotted Shell is used, it increases the damage of all subsequent infernal shots by <em>2%</em> until the end of battle.',
						unlock: 181,
						type: 'level',
					},
				],
			},
			{ name: 'Fatal Fusillade',
				type: 'level',
				image: './img/skills/olgath3.png',
				desc: 'Passive. Whenever Olgath hits with a normal attack, he loads <em>1</em> shell into Death Knell in the order of their creation. If Death Knell is already loaded with all shell types when Olgath hits a normal attack, that normal attack will be upgraded into an infernal shot. This effect can only trigger once every <em>8</em> seconds.',
				unlock: 41,
				upgrades: [
					{ desc: 'This effect can now trigger once every <em>6</em> seconds.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'This effect can now trigger once every <em>4</em> seconds.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'Each time an infernal shot hits, Death Knell will be loaded with <em>1</em> shell of a type that it hasn\'t already been loaded with.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Cataclysmic Roar',
				...
				upgrades: [
					...
					{ desc: 'For each type of shell loaded into Death Knell, the damage of each roar is increased by <em>20%</em> of Olgath\'s Attack Rating. Cataclysmic Roar does not consume any shells.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'Cataclysmic Roar dispels any control effects affecting Olgath and causes Olgath to be immune to control effects for <em>3</em> seconds.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		si_benchmark: 0,
		sig_item: {
			name: 'Deadly Discernment',
			image: './img/si/olgath.png',
			desc: 'If Infernal Bombardment has hit all targetable enemies enough times to stop the bombardment, it will prioritize targets with the lowest current health.',
			upgrades: [
				{ desc: 'After Olgath\'s infernal shots have consumed all shell types, his Attack Rating will be increased by <em>5%</em> (up to <em>20%</em>) until the end of battle.',
					unlock: 10,
				},
				{ desc: 'After Olgath\'s infernal shots have consumed all shell types, his Attack Rating will be increased by <em>5%</em> (up to <em>40%</em>) until the end of battle.',
					unlock: 20,
				},
				{ desc: 'If an infernal shot is unable to deal any damage, Death Knell will regain all consumed shells.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			...
			image: './img/furniture/olgath.png',
			upgrades: [
				{ desc: 'Each time a shell is loaded into Death Knell, Olgath\'s Accuracy is increased by <em>10</em> points (up to <em>80</em>) until the end of the battle.',
					unlock: 3,
				},
				{ desc: 'Death Knell will be loaded with <em>3</em> of each type of shell at the start of battle.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'maetria_aw',
		name: 'Maetria (Awakened)',
		portrait: './img/portraits/maetria_aw.jpg',
		class: 'Mage',
		faction: 'Hypogean',
		type: 'Intelligence',
		tier: 'ascended',
		skills: [
			{ name: 'Crash and Burn',
				type: 'ascension',
				image: './img/skills/maetria_aw1.png',
				desc: 'Maetria deals damage to all enemies for <em>320%</em> of her Attack Rating. If a hit enemy is being burned by a Cataclysmic Flame or Apocalyptic Flame, any shields they receive over the next <em>7</em> seconds will be destroyed after <em>1</em> second. When an enemy\'s shield is destroyed, they will take damage equal to the shield\'s remaining value. This damage cannot exceed <em>400%</em> of Maetria\'s Attack Rating. This effect cannot stack and can only be triggered once every <em>3</em> seconds.<br/><br/>If an enemy being burned by an Apocalyptic Flame is hit by this skill, it will also terrify them for <em>3</em> seconds.',
				unlock: 'Legendary',
				upgrades: [
					{ desc: 'For every enemy being burned by a Cataclysmic Flame or Apocalyptic Flame, the damage of this skill is increased by <em>15%</em>.',
						unlock: 'Mythic',
						type: 'ascension',
					},
					{ desc: 'If Immortal Blaze has been unlocked when Maetria uses this skill, the enemy who has dealt the most total damage will be hit by a Cataclysmic Flame, and they will deal <em>50%</em> less damage for the next <em>7</em> seconds. This effect cannot stack.',
						unlock: 'Ascended',
						type: 'ascension',
					},
				],
			...
			{ name: 'Immortal Blaze',
				type: 'level',
				image: './img/skills/maetria_aw2.png',
				desc: 'Maetria deals damage to enemies in front of her for <em>280%</em> of her Attack Rating and hurls a Cataclysmic Flame at the enemy in range with the highest Attack Rating. An enemy being burned by a Cataclysmic Flame loses <em>2%</em> of their max health per second (up to <em>200%</em> of Maetria\'s Attack Rating). Cataclysmic Flames cannot be dispelled.<br/><br/>If an enemy being burned by a Cataclysmic Flame is hit by another Cataclysmic Flame, the enemy will lose <em>600</em> Energy and the flame will turn into an Apocalyptic Flame, while the health the enemy loses per second will be increased by <em>50%</em>. The Apocalyptic Flame will revert to a Cataclysmic Flame after <em>4</em> seconds. The effects of Apocalyptic Flames are not stackable, but their duration can be extended.',
				unlock: 21,
				upgrades: [
					{ desc: 'The duration of Apocalyptic Flames is increased to <em>6</em> seconds.',
						unlock: 0,
						type: 'si',
					},
					{ desc: 'The duration of Apocalyptic Flames is increased to <em>7</em> seconds.',
						unlock: 10,
						type: 'si',
					},
					{ desc: 'When being burned by an Apocalyptic Flame, an enemy\'s Tenacity and Dissolve are both reduced by <em>30</em> points.',
						unlock: 20,
						type: 'si',
					},
					{ desc: 'If an enemy being burned by a Cataclysmic Flame or Apocalyptic Flame is hit by another Cataclysmic Flame through the skill "Immortal Blaze", the Cataclysmic Flame will spread to the nearest enemy, prioritizing enemies that are not being burned by a Cataclysmic Flame.',
						unlock: 30,
						type: 'si',
					},
				],
			...
			{ name: 'From the Ashes',
				type: 'level',
				image: './img/skills/maetria_aw3.png',
				desc: 'Every time Maetria dies, she transforms into a fireball. While in fireball mode, she is not considered a living hero, and cannot be targeted. She will resurrect after her allies have used their active skills <em>18</em> times or all allied heroes have died. Before she resurrects, the damage dealt by her Cataclysmic Flames is reduced by <em>40%</em>.<br/><br/>When she resurrects, Maetria damages nearby enemies for <em>150%</em> of her Attack Rating and terrifies them for <em>2</em> seconds. Maetria can resurrect up to <em>2</em> times. This skill cannot be used while you have Talene in your formation.',
				unlock: 41,
				upgrades: [
					{ desc: 'When Maetria resurrects, she damages nearby enemies for <em>220%</em> of her Attack Rating. For every enemy Celestial or Dimensional hero on the battlefield, the number of times Maetria\'s allies need to use their active skills for her to resurrect is reduced by <em>2</em>.',
						unlock: 3,
						type: 'furn',
					},
					{ desc: 'Maetria can now resurrect up to <em>3</em> times. For every enemy Celestial or Dimensional hero on the battlefield, the damage dealt by her Cataclysmic Flames is increased by <em>10%</em>.',
						unlock: 9,
						type: 'furn',
					},
				],
			...
			{ name: 'Smoldering Flame',
				type: 'level',
				image: './img/skills/maetria_aw4.png',
				desc: 'Passive. Whenever a hero\'s health falls below <em>15%</em>, they become fuel for the Solaran Furnace and a <em>7</em> second countdown begins. The hero dies when the countdown ends. This effect can only be triggered once for each hero. During the countdown, Maetria absorbs <em>50</em> points of the hero\'s Energy per second.<br/><br/>After the affected hero dies, they leave behind a Smoldering Flame that deals damage for <em>50%</em> of Maetria\'s Attack Rating to nearby heroes every second.<br/><br/>When this skill is used against a Boss, it will deal one-off damage to the Boss for <em>600%</em> of Maetria\'s Attack Rating.',
				unlock: 61,
				upgrades: [
					{ desc: 'If the countdown is for an allied hero, the damage they take is reduced by <em>35%</em>. If it is for an enemy hero, the damage they take is increased by <em>35%</em>.',
						unlock: 30,
						type: 'engraving',
					},
					{ desc: 'When the countdown ends, Maetria permanently receives the hero\'s current Attack Rating, Defense Rating, and remaining health (up to <em>100%</em> of her initial Attack Rating for all attribute bonuses). When the hero\'s Smoldering Flame appears, nearby enemies will be burned by Cataclysmic Flames. This effect can also trigger if the hero dies before the countdown ends.',
						unlock: 60,
						type: 'engraving',
					},
				],
			...
			{ name: 'Fallen Flame',
				type: 'level',
				image: './img/skills/maetria_aw5.png',
				desc: 'Allied heroes that are not Dimensionals or Celestials will be regarded by Maetria as Hypogeans and receive Hypogean factional bonuses as in-combat buffs. These in-combat buffs will be based on the number of Hypogeans in your formation, including heroes regarded as Hypogeans because of this skill.<br/><br/>These in-combat buffs will not affect any factional bonuses in effect at the start of the battle. The affected heroes will also gain a <em>25%</em> damage bonus against Celestials and <em>10</em> Proficiency points in this battle.',
				unlock: 81,
				upgrades: [],
			},
			{ name: 'Endeavor',
		...
		si_benchmark: 30,
		sig_item: {
			name: 'Strengthen Immortal Blaze',
			image: './img/si/maetria_aw.png',
			desc: 'The duration of Apocalyptic Flames is increased to <em>6</em> seconds.',
			upgrades: [
				{ desc: 'The duration of Apocalyptic Flames is increased to <em>7</em> seconds.',
					unlock: 10,
		...
		furn_benchmark: 9,
		furniture: {
			name: 'Strengthen From the Ashes',
			image: './img/furniture/maetria_aw.png',
			upgrades: [
				{ desc: 'When Maetria resurrects, she damages nearby enemies for <em>220%</em> of her Attack Rating. For every enemy Celestial or Dimensional hero on the battlefield, the number of times Maetria\'s allies need to use their active skills for her to resurrect is reduced by <em>2</em>.',
					unlock: 3,
				},
	...
	{ id: 'mulan',
		name: 'Mulan',
		portrait: './img/portraits/mulan.jpg',
		class: 'Ranger',
		faction: 'Dimensional',
		type: 'Agility',
		tier: 'ascended',
		skills: [
			{ name: 'Rider\'s Wrath',
				type: 'level',
				image: './img/skills/mulan1.png',
				desc: 'Mulan enters cavalry mode and charges across the battlefield <em>1</em> time. She will chart a path with the most enemy heroes, damaging all enemies in her path for <em>200%</em> of her Attack Rating and briefly knocking them airborne. Mulan then gallops to the area with the most enemy heroes, exits cavalry mode, and leaps off her horse, damaging nearby enemy heroes for <em>240%</em> of her Attack Rating and knocking them airborne. While in cavalry mode, Mulan is immune to damage and control effects.',
				unlock: 1,
				upgrades: [
					{ desc: 'While in cavalry mode, Mulan recovers <em>4%</em> of her max health every <em>1</em> second. She can recover up to <em>20%</em> of her max health each time she enters cavalry mode.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'When leaping off her horse, Mulan deals additional damage to her targets equal to <em>10%</em> of her max health. The additional damage cannot exceed <em>400%</em> of her Attack Rating.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Flashing Steel',
				type: 'level',
				image: './img/skills/mulan2.png',
				desc: 'Mulan slashes repeatedly with her sword, damaging enemies in front of her <em>2</em> times for <em>200%</em> of her Attack Rating. She then teleports and unleashes another flurry of slashes, damaging enemies in front of her <em>3</em> times for <em>200%</em> of her Attack Rating.<br/><br/>While using this skill, Mulan is immune to direct damage and control effects, but the amount of damage negated will be recorded. After the skill ends, she will lose health equal to <em>80%</em> of the negated damage. This damage cannot kill her.',
				unlock: 11,
				upgrades: [
					{ desc: 'After this skill ends, Mulan will be healed for <em>20%</em> of the damage it dealt.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'After this skill ends, Mulan will lose health equal to <em>50%</em> of the damage it negated. This damage cannot kill her.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'The second flurry of slashes after Mulan teleports will knock enemies airborne.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Formidable Fortress',
				type: 'level',
				image: './img/skills/mulan3.png',
				desc: 'Active: Mulan fly-kicks enemies in front of her, damaging them for <em>280%</em> of her Attack Rating and knocking them airborne.<br/><br/>Passive: If Mulan is about to receive damage that exceeds <em>10%</em> of her max health or would reduce her to less than <em>10%</em> health, she will parry the attack with her sword and damage enemies in front of her for <em>200%</em> of her Attack Rating. Parrying reduces the damage she takes by <em>50%</em>. She can parry <em>4</em> times over the next <em>3</em> seconds, after which the colldown for this skill\'s active effect will be reset and Mulan will be unable to parry again for the next <em>12</em> seconds.',
				unlock: 41,
				upgrades: [
					{ desc: 'After fly-kicking, Mulan\'s movement speed is increased by <em>25%</em> for <em>3</em> seconds. This effect cannot stack.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'When parrying, the damage Mulan receives is reduced by <em>70%</em>.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'Before fly-kicking, Mulan destroys all of the targets\' shields and renders them unable to acquire a new shield for the next <em>3</em> seconds.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Relentless Pursuit',
				type: 'level',
				image: './img/skills/mulan4.png',
				desc: 'Passive. Whenever Mulan knocks an enemy hero airborne, she hits them with a follow-up attack, damaging them for <em>100%</em> of her Attack Rating. Each follow-up attack increases the damage of the next follow-up attack by <em>20%</em> of Mulan\'s Attack Rating, up to <em>300%</em>. If the target is a Boss, Mulan will still launch a follow-up attack even if she fails to knock them airborne.',
				unlock: 61,
				upgrades: [
					{ desc: 'When Mulan knocks an enemy airborne to the edge of the battlefield, she damages the target and nearby enemies for <em>280%</em> of her Attack Rating. This effect can be triggered for each enemy hero once every <em>5</em> seconds.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'Once the damage of Mulan\'s follow-up attacks maxes out, subsequent follow-up attacks will deal extra damage to the target equal to <em>10%</em> of the target\'s max health. This extra damage cannot exceed <em>300%</em> of Mulan\'s Attack Rating.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'Control effects inflicted by Mulan\'s allied heroes will also trigger follow-up attacks. This effect can trigger for each allied hero once every <em>3</em> seconds.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			...
			image: './img/si/mulan.png',
			desc: 'If Mulan parries a skill, any subsequent damage it deals to her will be reduced by <em>10%</em>. This effect cannot stack.',
			upgrades: [
				{ desc: 'After Mulan parries an attack with Formidable Fortress, the Damage Reduction from the parry will continue for <em>3</em> seconds.',
					unlock: 10,
				},
				{ desc: 'If Mulan parries a skill, any subsequent damage it deals to her will be reduced by <em>30%</em>. This effect cannot stack.',
					unlock: 20,
				},
				{ desc: 'Mulan can also parry control effects that are about to be inflicted on her. While parrying, she is immune to control effects.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			name: 'Press On',
			image: './img/furniture/mulan.png',
			upgrades: [
				{ desc: 'While Mulan is in cavalry mode and for <em>5</em> seconds after she exits cavalry mode, all allied heroes gain <em>20%</em> Attack Rating and <em>20%</em> Defense Rating. This effect cannot stack.',
					unlock: 3,
				},
				{ desc: 'At the start of battle, Mulan enters cavalry mode and rides towards the enemy directly opposite her. She then leaps off her horse and exits cavalry mode, damaging nearby enemies and knocking them airborne in the same manner as Rider\'s Wrath.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'emilia',
		name: 'Emilia',
		portrait: './img/portraits/emilia.jpg',
		class: 'Mage',
		faction: 'Dimensional',
		type: 'Intelligence',
		tier: 'ascended',
		skills: [
			{ name: 'Essence of the Spiritual Arts User',
				type: 'level',
				image: './img/skills/emilia1.png',
				desc: 'Emilia cannot gain Energy by attacking, getting attacked, or through any other method. She starts the battle with <em>1000</em> Energy and will immediately cast her Ultimate to summon Puck to assist her. Using her Ultimate skill does not cost Energy, but while Puck is present, Emilia will lose <em>100</em> Energy per second. When her Energy reaches <em>0</em>, Puck goes to sleep.<br/><br/>While Puck is summoned, it will continuously fire ice crystals at the area with the most enemies, dealing damage equal to <em>350%</em> of Emilia\'s Attack Rating to all targets and inflicting the Frost effect on them for <em>6</em> seconds. Each time a target with the Frost effect takes damage, they will take extra damage equal to <em>350%</em> of Emilia\'s Attack Rating. Each enemy can only trigger this effect once every <em>2</em> seconds.<br/><br/>While Puck is asleep, Emilia recovers <em>150</em> Energy every time an allied hero uses their Ultimate, until she uses her Ultimate to summon Puck again.',
				unlock: 1,
				upgrades: [
					{ desc: 'The extra damage caused by Frost is increased to <em>450%</em> of Emilia\'s Attack Rating.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'Enemies that take extra damage from Frost <em>3</em> times become frozen for <em>2</em> seconds.',
						unlock: 161,
						type: 'level',
					},
				],
			...
			{ name: 'Ice Flower',
				type: 'level',
				image: './img/skills/emilia2.png',
				desc: 'Emilia calls upon the mana in the air and freezes all enemies for <em>0.5</em> to <em>1.5</em> seconds. The lower the current health of an enemy, the longer they will be frozen for.',
				unlock: 11,
				upgrades: [
					{ desc: 'Enemies are now frozen for <em>1</em> to <em>2</em> seconds.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'Enemies are now frozen for <em>2</em> to <em>4</em> seconds.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'If an enemy is immune to control effects or is already frozen, they will instead take damage equal to <em>400%</em> of Emilia\'s Attack Rating.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Lesser Spirit\'s Blessing',
				type: 'level',
				image: './img/skills/emilia3.png',
				desc: 'Emilia receives a lesser spirit\'s blessing and creates a blessed zone for <em>8</em> seconds. Allied heroes in the zone will recover health equal to <em>120%</em> of Emilia\'s Attack Rating and <em>40</em> Energy per second.',
				unlock: 41,
				upgrades: [
					{ desc: 'The blessed zone is expanded.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'Allied heroes in the zone gain <em>30</em> points of Haste.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'Allied heroes outside the zone will receive its effects at half strength.',
						unlock: 30,
						type: 'engraving',
					},
				],
			},
			{ name: 'The Great Spirit\'s Might',
				type: 'level',
				image: './img/skills/emilia4.png',
				desc: 'If Emilia dies, Puck goes on a rampage, "freezing" all characters on both sides and damaging everyone for <em>400%</em> of Emilia\'s Attack Rating, plus additional damage equal to <em>10%</em> of the health lost by all enemies (up to <em>600%</em> of Emilia\'s Attack Rating). Allied characters will only take <em>50%</em> of the damage after a <em>0.5</em> second delay. If Emilia is the only surviving allied hero, she will become immune to fatal damage and invincible for <em>2</em> seconds, and this effect will trigger immediately. This effect can only trigger <em>1</em> time per battle. Emilia is immune to any damage dealt by Puck while he is on a rampage.',
				unlock: 61,
				upgrades: [
					{ desc: 'Base damage is increased to <em>500%</em> of Emilia\'s Attack RAting.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'Additional damage is increased to <em>20%</em> of the health lost by all enemies and the maximum damage is increased to <em>800%</em> of Emilia\'s Attack Rating.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'When the Great Spirit Puck goes on a rampage, allied heroes no longer take damage from this skill. If Emilia is the only surviving allied hero, she will recover all her health.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		sig_item: {
			name: 'Ice User',
			image: './img/si/emilia.png',
			desc: 'The Defense Rating of frozen enemies is reduced by <em>20%</em>.',
			upgrades: [
				{ desc: 'Frozen enemies lose <em>50</em> Energy per second.',
					unlock: 10,
				},
				{ desc: 'After coming out of being frozen, an enemy\'s Defense Rating is permanently reduced by <em>25%</em>. This effect can stack up to <em>2</em> times.',
					unlock: 20,
				},
				{ desc: 'When an allied hero other than Emilia deals damage to a frozen enemy, the allied hero recovers <em>100</em> Energy points. This effect can only be triggered by eah ally once every <em>3</em> seconds.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			name: 'Familial Bond',
			image: './img/furniture/emilia.png',
			upgrades: [
				{ desc: 'Emilia\'s Energy consumption while Puck is summoned is reduced to <em>50</em> points per second.',
					unlock: 3,
				},
				{ desc: 'When both the enemy and allied hero uses their Ultimate while Puck is asleep, Emilia\'s gained Energy is increased to <em>200</em> points.',
					unlock: 9,
				},
			],
		},
	...
	{ id: 'rem',
		name: 'Rem',
		portrait: './img/portraits/rem.jpg',
		class: 'Warrior',
		faction: 'Dimensional',
		type: 'Strength',
		tier: 'ascended',
		skills: [
			{ name: 'Demon Form',
				type: 'level',
				image: './img/skills/rem1.png',
				desc: 'Rem enters her demon form for <em>8</em> seconds (she will not exit demon form while other skills are being used) and swings her Morning Star multiple times, damaging nearby enemies for <em>200%</em> of her Attack Rating per hit. In demon form, Rem deals <em>20%</em> more damage and drains <em>10</em> Energy from all enemy heroes every <em>2</em> seconds. If Rem uses her Ultimate while already in demon form, the duration of her demon form will be reset, and the effect of her current Morning Star swings will be enhanced, dealing damage multiple times each equal to <em>250%</em> of her Attack Rating and knocking targets airborne.',
				unlock: 1,
				upgrades: [
					{ desc: 'While in Demon Form, Rem\'s normal attack speed is increased by <em>20</em> points, and <em>40%</em> of the damage she deals will be converted into healing for herself.',
						unlock: 81,
						type: 'level',
					},
					{ desc: 'The Energy Rem drains from all enemy heroes is increased to <em>15</em> points every <em>2</em> seconds.',
						unlock: 161,
						type: 'level',
					},
				],
			},
			{ name: 'Morning Star Swing',
				type: 'level',
				image: './img/skills/rem2.png',
				desc: 'Rem uses her Morning Star to smash the enemy hero who has dealt the highest total damage, damaging the enemy for <em>200%</em> of her Attack Rating, knocking them back, and reducing their Energy by <em>250</em> points. If the enemy is knocked to the edge of the battlefield, they will take additional damage equal to <em>150%</em> of her Attack Rating and be stunned for <em>1</em> second.',
				unlock: 11,
				upgrades: [
					{ desc: 'The damage of the initial smash is increased to <em>250%</em> of Rem\'s Attack Rating.',
						unlock: 21,
						type: 'level',
					},
					{ desc: 'The damage of the initial smash is increased to <em>300%</em> of Rem\'s Attack Rating.',
						unlock: 101,
						type: 'level',
					},
					{ desc: 'The Energy reduction is increased to <em>300</em> points.',
						unlock: 181,
						type: 'level',
					},
				],
			...
			{ name: 'Healing Mana',
				type: 'level',
				image: './img/skills/rem3.png',
				desc: 'Rem uses healing mana to heal the allied hero with the lowest health for <em>10%</em> of their max health. The allied hero also receives a shield worth <em>300%</em> of Rem\'s Attack Rating. The healing mana\'s effects linger for <em>4</em> seconds, increasing the healing that the ally receives by <em>20</em> points and healing them for <em>40%</em> of Rem\'s Attack Rating every second.',
				unlock: 41,
				upgrades: [
					{ desc: 'The initial healing is increased to <em>15%</em> of the allied hero\'s max health.',
						unlock: 121,
						type: 'level',
					},
					{ desc: 'The initial healing is increased to <em>20%</em> of the allied hero\'s max health.',
						unlock: 201,
						type: 'level',
					},
					{ desc: 'The healing mana\'s effects now linger for <em>8</em> seconds and heal the allied hero for <em>80%</em> of Rem\'s Attack Rating per second.',
						unlock: 30,
						type: 'engraving',
					},
				],
			...
			{ name: 'Demon Tribe',
				type: 'level',
				image: './img/skills/rem4.png',
				desc: 'Passive. Rem\'s Attack Rating permanently increases the more her allies take damage. For every <em>1%</em> of their max health an ally loses, Rem\'s Attack Rating is increased by <em>2%</em> (up to <em>200%</em> of Rem\'s initial Attack Rating).',
				unlock: 61,
				upgrades: [
					{ desc: 'The limit is increased to <em>300%</em> of Rem\'s initial Attack Rating.',
						unlock: 141,
						type: 'level',
					},
					{ desc: 'For each allied hero that dies, Rem permanently gains <em>10</em> points of Haste.',
						unlock: 221,
						type: 'level',
					},
					{ desc: 'For each allied hero that dies, Rem permanently gains <em>20%</em> damage reduction.',
						unlock: 60,
						type: 'engraving',
					},
				],
		...
		si_benchmark: 20,
		sig_item: {
			name: 'The Demon Survivor',
			image: './img/si/rem.png',
			desc: 'All damage Rem deals with her Morning Star is increased by <em>10%</em>.',
			upgrades: [
				{ desc: 'All damage Rem deals with her Morning Star is increased by <em>20%</em>. <em>75%</em> of this additional damage ignores enemy shields.',
					unlock: 10,
				},
				{ desc: 'All damage Rem deals with her Morning Star is increased by <em>30%</em>. <em>75%</em> of this additional damage ignores enemy shields.',
					unlock: 20,
				},
				{ desc: 'While Rem is in Demon Form, <em>100%</em> of the damage dealt by her Ultimate ignores enemy shields.',
					unlock: 30,
				},
			],
		},
		...
		furniture: {
			name: 'Almighty Maid',
			image: './img/furniture/rem.png',
			upgrades: [
				{ desc: 'When an allied hero takes fatal damage, they will immediately receive the effects of the Healing Mana skill and become immune to damage for <em>0.5</em> seconds. This effect can only be triggered by each ally once per battle.',
					unlock: 3,
				},
				{ desc: 'The Healing Mana skill triggered when an allied hero takes fatal damage also restores their Energy by <em>500</em> points.',
					unlock: 9,
				},
			],
		},
