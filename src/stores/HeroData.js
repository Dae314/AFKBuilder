		...
		skills: [
			...
			{ name: 'Reviler\'s Defiance',
				...
				upgrades: [
					...
					{ desc: 'Blocking time is ignored, Hodgekin shall always deal damage equal to <em>20%</em> of the target\'s max health.',
						unlock: 60,
						type: 'engraving',
					},
				],
	...
	{ id: 'framton',
		...
		skills: [
			{ name: 'Blazing Meteor',
				...
				desc: 'Framton throws all enemeis in front of him up into the air, who come crashing down several moments later onto the nearest enemy target, dealing <em>410%</em> damage to all affected enemies, also stunning them for <em>2</em> seconds. Every enemy that Framton successfully throws into the air increases his Attack Rating for <em>8</em> seconds by a value equal to <em>15%</em> of each enemy\'s Attack Rating, but the total value cannot exceed <em>30%</em> of his own current Attack Rating. This ability does not affect bosses or control-immune enemies.',
				unlock: 1,
				upgrades: [
		...
		furniture: {
			...
			upgrades: [
				...
				{ desc: 'After triggering "Flame Feast", Framton immediately gains <em>40</em> Blaze Points.',
					unlock: 9,
				},
			],
		},
