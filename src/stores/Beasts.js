...
const Beasts = readable([
	...
	{ id: 'savage_souffle',
		name: 'Savage Souffle',
		portrait: './img/beasts/portraits/savage_souffle.png',
		tier: 'elite',
		skills: [
			{ name: 'Flavorful Frenzy',
				type: 'level',
				image: './img/beasts/skills/savage_souffle1.png',
				desc: 'Savage Souffle summons Candy Clouds, restoring the Energy of all allied heroes by <em>100</em> points. Savage Souffle then rains down Marzipan Meteors, damaging all enemies <em>3</em> times for <em>200%</em> of its Attack Rating. Whenever heroes on either side use or lose Energy, Savage Souffle will gain bonus Beast Energy.',
				unlock: 0,
				upgrades: [
					{ desc: 'Savage Souffle "cakeifies" <em>1</em> enemy, turning them into strawberry cakes that cannot attack for <em>5</em> seconds. Savage Souffle will prioritize enemy heroes that have dealt the most total damage and are not immune to control effects.',
						unlock: 6,
						type: 'level',
					},
					{ desc: 'Candy Clouds will drop <em>5</em> Boom-Boom Buns on the battlefield. Boom-Boom Buns will explode after <em>5</em> seconds or whenever a heroes goes near it, damaging all nearby enemy heroes for <em>250%</em> of Savage Souffle\'s Attack Rating and immobilizing them for <em>2</em> seconds.',
						unlock: 12,
						type: 'level',
					},
					{ desc: 'Cakeified targets take <em>35%</em> extra damage and have their Defense Ratings reduced by <em>35%</em> (up to <em>35%</em> of Savage Souffle\'s Defense Rating) whether they change shape or not for <em>5</em> seconds.',
						unlock: 18,
						type: 'level',
					},
				],
			...
			{ name: 'Basic Training',
				type: 'level',
				image: './img/beasts/skills/savage_souffle2.png',
				desc: 'Increases the Energy recovery of allied heroes to <em>150</em> while Candy Clouds are on the battlefield.',
				unlock: 3,
				upgrades: [
				],
			},
			{ name: 'Intermediate Training',
				type: 'level',
				image: './img/beasts/skills/savage_souffle3.png',
				desc: '<em>1</em> additional target can be cakeified.',
				unlock: 9,
				upgrades: [
				],
			},
			{ name: 'Advanced Training',
				type: 'level',
				image: './img/beasts/skills/savage_souffle4.png',
				desc: 'When Boom-Boom Buns explode, they dispel most Energy recovery restriction/reduction effects from nearby allied heroes and restores their Energy by <em>100</em> points.',
				unlock: 15,
				upgrades: [
				],
			},
	...
	{ id: 'slumber_seal',
		name: 'Slumber Seal',
		portrait: './img/beasts/portraits/slumber_seal.png',
		tier: 'elite',
		skills: [
			{ name: 'Ocean Song',
				type: 'level',
				image: './img/beasts/skills/slumber_seal1.png',
				desc: 'Slumber Seal can sleep soundly through any battle. It spawns <em>1</em> aquatic spirits every <em>1.5</em> seconds to attack the enemy with the lowest health, dealing beast damage equal to <em>220%</em> of its Attack Rating. Each time an allied hero receives or resists a control or limitation effect, <em>1</em> aquatic spirits will drop around Slumber Seal, up to <em>5</em> every <em>6</em> seconds. It can also retrieve aquatic spirits from the battlefield, increasing damage dealt by them permanently by <em>12.5%</em>, up to <em>200%</em>.',
				unlock: 0,
				upgrades: [
					{ desc: 'Slumber Seal moves quickly to the center of the battlefield, stirring up <em>3</em> waves to attack enemies. Each time an enemy is struck by the waves, they receive beast damage equal to <em>300%</em> of its Attack Rating and are knocked back a short distance. Each time an allied hero receives or resists a control or limitation effect, Slumber Seal receives additional beast energy.',
						unlock: 6,
						type: 'level',
					},
					{ desc: 'The enemy hit by the last wave is trapped in a bubble for <em>3</em> seconds. Damage taken by the enemy while trapped is increased by <em>40%</em>; for beast damage, it is increased further by <em>40%</em>.',
						unlock: 12,
						type: 'level',
					},
					{ desc: 'Each time an enemy is trapped in a bubble, Slumber Seal spawns an additional <em>1</em> aquatic spirits to attack the enemy, dealing further damage equal to <em>10%</em> of the enemy\'s max health, up to <em>600%</em> of its Attack Rating.',
						unlock: 18,
						type: 'level',
					},
				],
			...
			{ name: 'Basic Training',
				type: 'level',
				image: './img/beasts/skills/slumber_seal2.png',
				desc: 'Each time Slumber Seal retrieves aquatic spirits, its Attack Rating is permanently increased by <em>15%</em> of the current Attack Rating of the hero that triggered its skill. The attributes it receives as a result will not exceed <em>60%</em> of the total initial Attack Rating of all allied heroes in the battle.',
				unlock: 3,
				upgrades: [
				],
			},
			{ name: 'Intermediate Training',
				type: 'level',
				image: './img/beasts/skills/slumber_seal3.png',
				desc: 'When any allied hero does not receive or resist a control limitation effect for <em>5</em> seconds, Slumber Seal will receive extra beast energy while <em>1</em> aquatic spirit will drop at random places. This effect can only trigger once every <em>2.5</em> seconds.',
				unlock: 9,
				upgrades: [
				],
			},
			{ name: 'Advanced Training',
				type: 'level',
				image: './img/beasts/skills/slumber_seal4.png',
				desc: 'Each time Slumber Seal retrieves aquatic spirits, its Crit Rating and Crit Damage Amplification are permanently increased by <em>15%</em> of the original hero\'s current Crit Rating and Crit Damage Amplification. The attribute buffs it receives as a result shall not exceed <em>120%</em> of the total initial attributes of all allied hroes in the battle.',
				unlock: 15,
				upgrades: [
				],
			},
	...
	{ id: 'fox_fatale',
		name: 'Fox Fatale',
		portrait: './img/beasts/portraits/fox_fatale.png',
		tier: 'elite',
		skills: [
			{ name: 'Seductive Dance',
				type: 'level',
				image: './img/beasts/skills/fox_fatale1.png',
				desc: 'Fox Fatale inflicts a Degenerate effect for <em>6</em> seconds on the enemy hero that has dealt the highest damage. While suffering from a Degenerate effect, damage dealt by an enemy is reduced by <em>40%</em>. The Degenerate effect cannot be stacked.<br/><br/>Fox Fatale then targets up to <em>3</em> enemy heroes that have dealt the highest damage, bouncing between them and causing them to be lost. The targets that were lost before Fox Fatale leaves the battlefield continue to follow Fox Fatale. When an allied hero deals damage to an enemy suffering from a Degnerate effect, Fox Fatale receives additional beast energy.',
				unlock: 0,
				upgrades: [
					{ desc: 'At the start of a battle, Fox Fatale inflicts a Degenerate effect for <em>8</em> seconds on the enemy hero with the highest Attack Rating.',
						unlock: 6,
						type: 'level',
					},
					{ desc: 'While Leaving the battlefield, Fox Fatale jumps onto the area most dense with enemies, dealing beat damage to surrounding enemies for <em>300%</em> of its Attack Rating and charming them for <em>4</em> seconds. While charmed, the enemy can only use Normal Attacks.',
						unlock: 12,
						type: 'level',
					},
					{ desc: 'After Fox Fatale uses this skill, the normal Attacks and skills of its allied heroes will prioritize targeting enemies under a Degenerate effect, and damage dealt by allied heroes to them is increased by <em>40%</em> for <em>6</em> seconds. This effect cannot be stacked.',
						unlock: 18,
						type: 'level',
					},
				],
			...
			{ name: 'Basic Training',
				type: 'level',
				image: './img/beasts/skills/fox_fatale2.png',
				desc: 'While suffering from a Degenerate effect, Energy Recovery received by an enemy in any way is reduced by <em>80%</em>.',
				unlock: 3,
				upgrades: [
				],
			},
			{ name: 'Intermediate Training',
				type: 'level',
				image: './img/beasts/skills/fox_fatale3.png',
				desc: 'While suffering from a Degenerate effect, an enemy has their Attack Rating reduced by <em>60%</em>, up to <em>60%</em> of Fox Fatale\'s Attck Rating. However, if the enemy is charmed by Fox Fatale at the same time, the enemy\'s Attack Rating will be increased by <em>25%</em> instead.',
				unlock: 9,
				upgrades: [
				],
			},
			{ name: 'Advanced Training',
				type: 'level',
				image: './img/beasts/skills/fox_fatale4.png',
				desc: 'The charm durtion is incresed to <em>6</em> seconds. Enemies that are charmed at the same time can use any skills other than their Ultimate.',
				unlock: 15,
				upgrades: [
				],
			},
